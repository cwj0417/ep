...
半夜麻了0次，睡醒麻了0次`,hh:0,s3:0,s4:0}},a1={id:"cont-wrap"},u1={id:"calender-wrap"},h1={id:"calender-head"},d1={class:"calender-year"},p1={class:"tag s3"},g1={class:"tag s4"},m1={class:"tag hh"},_1=["onClick"],b1={class:"date"},y1={class:"opt-head"},v1=["onClick"],x1=["onClick"],w1={class:"strat setall"},S1={key:0,class:"tag s3"},C1={key:1,class:"tag s4"},T1={key:2,class:"tag hh"},O1={key:3,style:{"font-weight":"900","font-size":"16px",padding:"10px 20px"}},E1={key:4,style:{"font-weight":"900","font-size":"16px",padding:"10px 20px"}},A1={__name:"App",setup(e){const n=S=>S<10?`0${S}`:S,t=S=>{const A=new Date(+S);return`${A.getFullYear()}-${n(A.getMonth()+1)}-${n(A.getDate())}`},s=Object.fromEntries(Object.entries(f1).map(([S,A])=>[new Date(S).valueOf(),A])),i=["2024-01-27",t(Date.now()+864e5*7)],l=(new Date(i[1])-new Date(i[0]))/864e5,r=new Date(i[0]).valueOf(),o=gt(new Date(i[0]).valueOf()+864e5*4),f=En(Ds),d=gt(0);let u={};const p=S=>{var A;d.value=S.toString(),(A=u[S])==null||A.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})};let C=0,T=null;const D=gt(!0),I=S=>{if(!T){const A=S.target;D.value=C>A.scrollTop,C=A.scrollTop;const H=new Date(i[0]).valueOf()+(new Date(i[1])-new Date(i[0]))/A.scrollHeight*(A.scrollTop+A.clientHeight/2);o.value=H,T=setTimeout(()=>{T=null},350)}},F=En({s3:{days:0,count:0},s4:{days:0,count:0},hh:{days:0,count:0}});Sn(o,()=>{const S=new Date(o.value).getMonth(),A=new Date(o.value).getFullYear();F.s3.days=0,F.s3.count=0,F.s4.days=0,F.s4.count=0,F.hh.days=0,F.hh.count=0;for(const[H,$]of Object.entries(s)){const ne=new Date(+H);ne.getMonth()===S&&ne.getFullYear()===A&&($.s3&&(F.s3.days++,F.s3.count+=$.s3),$.s4&&(F.s4.days++,F.s4.count+=$.s4),$.hh&&(F.hh.days++,F.hh.count+=$.hh))}});let N=null;const G=S=>{N||(D.value=!1,N=setTimeout(()=>{N=null},350))},Y=S=>{for(const A in Ds)["coner","memo","detail"].includes(A)||(f[A]=S?0:-1)};return Gt(()=>{const S=document.querySelector("#calander-body");S.scroll(0,S.scrollHeight*(new Date-new Date(i[0]))/(new Date(i[1])-new Date(i[0]))-S.clientHeight)}),(S,A)=>(oe(),ae(ue,null,[k("div",a1,[k("div",u1,[k("div",h1,[k("div",d1,[Pt(Z(new Date(o.value).getFullYear())+"年"+Z(new Date(o.value).getMonth()+1)+"月 ",1),k("span",p1,Z(F.s3.days)+"天, "+Z(F.s3.count)+"次",1),k("span",g1,Z(F.s4.days)+"天, "+Z(F.s4.count)+"次",1),k("span",m1,Z(F.hh.days)+"天, "+Z(F.hh.count)+"次",1)]),A[2]||(A[2]=Sl('<div class="calender-item">周日</div><div class="calender-item">周一</div><div class="calender-item">周二</div><div class="calender-item">周三</div><div class="calender-item">周四</div><div class="calender-item">周五</div><div class="calender-item">周六</div>',7))]),k("div",{id:"calander-body",onScroll:I},[(oe(),ae(ue,null,Un(l,H=>k("div",{class:ze(["calender-item card",{active:ve(r)+H*864e5-o.value<864e5*31&&new Date(ve(r)+H*864e5).getMonth()===new Date(o.value).getMonth()}]),onClick:$=>p(ve(r)+H*864e5),key:H},[k("div",b1,Z(new Date(ve(r)+H*864e5).getDate()),1),we(c1,{strategy:f,record:ve(s)[ve(r)+H*864e5]},null,8,["strategy","record"])],10,_1)),64))],32),k("div",{id:"strategy-select",style:nt(`transform: translateY(${D.value?0:"100%"})`)},[(oe(!0),ae(ue,null,Un(Object.entries(ve(It)),H=>(oe(),ae("div",{class:"strat",key:H[0]},[k("div",y1,Z(ve(r1)[H[0]]),1),(oe(!0),ae(ue,null,Un(H[1],($,ne)=>(oe(),ae("div",{class:ze(["option",{active:ne===f[H[0]]}]),onClick:fn=>f[H[0]]=ne,key:$.name},Z($.name),11,v1))),128)),k("div",{class:ze(["option",{active:f[H[0]]===-1}]),onClick:$=>f[H[0]]=-1}," 不渲染 ",10,x1)]))),128)),k("div",w1,[k("div",{class:"action",onClick:A[0]||(A[0]=H=>Y(!0))},"恢复默认"),k("div",{class:"action",onClick:A[1]||(A[1]=H=>Y(!1))},"关闭渲染")])],4)])]),k("div",{id:"detail",onScroll:G},[(oe(!0),ae(ue,null,Un(Object.entries(ve(s)),([H,$])=>(oe(),ae("div",{class:ze(["detail-card",d.value===H?"active":""]),ref_for:!0,ref:ne=>ve(u)[H]=ne,key:H},[Pt(Z(t(H))+" ",1),$.s3?(oe(),ae("span",S1,"小发 "+Z($.s3),1)):mn("",!0),$.s4?(oe(),ae("span",C1,"轻微 "+Z($.s4),1)):mn("",!0),$.hh?(oe(),ae("span",T1,"恍惚 "+Z($.hh),1)):mn("",!0),$.memo?(oe(),ae("pre",O1,Z($.memo),1)):mn("",!0),$.coner?(oe(),ae("pre",E1,Z($.coner[1]),1)):mn("",!0),k("pre",null,Z($.detail)+`

      `,1)],2))),128))],32)],64))}};s1(A1).mount("#app");
