...
23.38 烫
00.16 涨烫
        `}},Pn=Object.fromEntries(Object.entries(co).map(([e,t])=>[new Date(e).valueOf(),t])),fo={id:"cont-wrap"},uo={id:"calender-wrap"},ao={id:"calender-head"},ho={class:"calender-year"},po=["onClick"],go={class:"date"},mo={class:"strat"},_o={class:"opt-head"},bo=["onClick"],yo=["onClick"],vo={class:"strat setall"},xo={id:"detail"},wo={__name:"App",setup(e){const t=["2024-01-29","2024-12-30"],s=(new Date(t[1])-new Date(t[0]))/864e5,n=new Date(t[0]).valueOf(),i=nn(new Date(t[0]).valueOf()+864e5*4),r=es(Rn),l=M=>{const T=new Date(+M);return`${T.getFullYear()}-${T.getMonth()+1}-${T.getDate()}`};let c={};const f=M=>{var T;(T=c[M])==null||T.scrollIntoView({behavior:"smooth",block:"end",inline:"nearest"})};let h=0,a=null;const p=nn(!0),S=M=>{if(!a){const T=M.target;p.value=h>T.scrollTop,h=T.scrollTop;const F=new Date(t[0]).valueOf()+(new Date(t[1])-new Date(t[0]))/T.scrollHeight*(T.scrollTop+T.clientHeight/2);i.value=F,a=setTimeout(()=>{a=null},350)}},C=M=>{for(const T in Rn)r[T]=M?0:-1};return(M,T)=>(Oe(),Ee(re,null,[z("div",fo,[z("div",uo,[z("div",ao,[z("div",ho,De(new Date(i.value).getFullYear())+"年"+De(new Date(i.value).getMonth()+1)+"月 ",1),T[2]||(T[2]=wl('<div class="calender-item">周日</div><div class="calender-item">周一</div><div class="calender-item">周二</div><div class="calender-item">周三</div><div class="calender-item">周四</div><div class="calender-item">周五</div><div class="calender-item">周六</div>',7))]),z("div",{id:"calander-body",onScroll:S},[(Oe(),Ee(re,null,$t(s,F=>z("div",{class:st(["calender-item card",{active:pe(n)+F*864e5-i.value<864e5*31&&new Date(pe(n)+F*864e5).getMonth()===new Date(i.value).getMonth()}]),onClick:H=>f(pe(n)+F*864e5)},[z("div",go,De(new Date(pe(n)+F*864e5).getDate()),1),Pe(oo,{strategy:r,record:pe(Pn)[pe(n)+F*864e5]},null,8,["strategy","record"])],10,po)),64))],32),z("div",{id:"strategy-select",style:Qt(`transform: translateY(${p.value?0:"100%"})`)},[(Oe(!0),Ee(re,null,$t(Object.entries(pe(Rs)),F=>(Oe(),Ee("div",mo,[z("div",_o,De(pe(ro)[F[0]]),1),(Oe(!0),Ee(re,null,$t(F[1],(H,L)=>(Oe(),Ee("div",{class:st(["option",{active:L===r[F[0]]}]),onClick:W=>r[F[0]]=L},De(H.name),11,bo))),256)),z("div",{class:st(["option",{active:r[F[0]]===-1}]),onClick:H=>r[F[0]]=-1}," 不渲染 ",10,yo)]))),256)),z("div",vo,[z("div",{class:"action",onClick:T[0]||(T[0]=F=>C(!0))},"恢复默认"),z("div",{class:"action",onClick:T[1]||(T[1]=F=>C(!1))},"关闭渲染")])],4)])]),z("div",xo,[(Oe(!0),Ee(re,null,$t(Object.entries(pe(Pn)),([F,H])=>(Oe(),Ee("div",{class:"detail-card",ref_for:!0,ref:L=>pe(c)[F]=L},[Mi(De(l(F))+" ",1),z("pre",null,"        "+De(H.detail)+`
