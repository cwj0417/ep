...
23.30才躺下
半夜麻了0次，睡醒麻了0次`,hh:9,s3:0,s4:2}},a2={id:"cont-wrap"},u2={id:"calender-wrap"},h2={id:"calender-head"},d2={class:"calender-year"},p2={class:"tag s3"},g2={class:"tag s4"},m2={class:"tag hh"},_2=["onClick"],b2={class:"date"},y2={class:"opt-head"},v2=["onClick"],x2=["onClick"],w2={class:"strat setall"},S2={key:0,class:"tag s3"},C2={key:1,class:"tag s4"},T2={key:2,class:"tag hh"},O2={key:3,style:{"font-weight":"900","font-size":"16px",padding:"10px 20px"}},E2={key:4,style:{"font-weight":"900","font-size":"16px",padding:"10px 20px"}},A2={__name:"App",setup(n){const e=S=>S<10?`0${S}`:S,t=S=>{const A=new Date(+S);return`${A.getFullYear()}-${e(A.getMonth()+1)}-${e(A.getDate())}`},s=Object.fromEntries(Object.entries(f2).map(([S,A])=>[new Date(S).valueOf(),A])),i=["2024-01-27",t(Date.now()+864e5*7)],l=(new Date(i[1])-new Date(i[0]))/864e5,r=new Date(i[0]).valueOf(),o=gt(new Date(i[0]).valueOf()+864e5*4),f=Ee(Ds),d=gt(0);let u={};const p=S=>{var A;d.value=S.toString(),(A=u[S])==null||A.scrollIntoView({behavior:"smooth",block:"center",inline:"nearest"})};let C=0,T=null;const D=gt(!0),I=S=>{if(!T){const A=S.target;D.value=C>A.scrollTop,C=A.scrollTop;const H=new Date(i[0]).valueOf()+(new Date(i[1])-new Date(i[0]))/A.scrollHeight*(A.scrollTop+A.clientHeight/2);o.value=H,T=setTimeout(()=>{T=null},350)}},F=Ee({s3:{days:0,count:0},s4:{days:0,count:0},hh:{days:0,count:0}});Se(o,()=>{const S=new Date(o.value).getMonth(),A=new Date(o.value).getFullYear();F.s3.days=0,F.s3.count=0,F.s4.days=0,F.s4.count=0,F.hh.days=0,F.hh.count=0;for(const[H,$]of Object.entries(s)){const en=new Date(+H);en.getMonth()===S&&en.getFullYear()===A&&($.s3&&(F.s3.days++,F.s3.count+=$.s3),$.s4&&(F.s4.days++,F.s4.count+=$.s4),$.hh&&(F.hh.days++,F.hh.count+=$.hh))}});let N=null;const G=S=>{N||(D.value=!1,N=setTimeout(()=>{N=null},350))},Y=S=>{for(const A in Ds)["coner","memo","detail"].includes(A)||(f[A]=S?0:-1)};return Gt(()=>{const S=document.querySelector("#calander-body");S.scroll(0,S.scrollHeight*(new Date-new Date(i[0]))/(new Date(i[1])-new Date(i[0]))-S.clientHeight)}),(S,A)=>(cn(),un(hn,null,[k("div",a2,[k("div",u2,[k("div",h2,[k("div",d2,[Pt(Z(new Date(o.value).getFullYear())+"年"+Z(new Date(o.value).getMonth()+1)+"月 ",1),k("span",p2,Z(F.s3.days)+"天, "+Z(F.s3.count)+"次",1),k("span",g2,Z(F.s4.days)+"天, "+Z(F.s4.count)+"次",1),k("span",m2,Z(F.hh.days)+"天, "+Z(F.hh.count)+"次",1)]),A[2]||(A[2]=S1('<div class="calender-item">周日</div><div class="calender-item">周一</div><div class="calender-item">周二</div><div class="calender-item">周三</div><div class="calender-item">周四</div><div class="calender-item">周五</div><div class="calender-item">周六</div>',7))]),k("div",{id:"calander-body",onScroll:I},[(cn(),un(hn,null,Ue(l,H=>k("div",{class:kn(["calender-item card",{active:xn(r)+H*864e5-o.value<864e5*31&&new Date(xn(r)+H*864e5).getMonth()===new Date(o.value).getMonth()}]),onClick:$=>p(xn(r)+H*864e5),key:H},[k("div",b2,Z(new Date(xn(r)+H*864e5).getDate()),1),Sn(c2,{strategy:f,record:xn(s)[xn(r)+H*864e5]},null,8,["strategy","record"])],10,_2)),64))],32),k("div",{id:"strategy-select",style:et(`transform: translateY(${D.value?0:"100%"})`)},[(cn(!0),un(hn,null,Ue(Object.entries(xn(It)),H=>(cn(),un("div",{class:"strat",key:H[0]},[k("div",y2,Z(xn(r2)[H[0]]),1),(cn(!0),un(hn,null,Ue(H[1],($,en)=>(cn(),un("div",{class:kn(["option",{active:en===f[H[0]]}]),onClick:fe=>f[H[0]]=en,key:$.name},Z($.name),11,v2))),128)),k("div",{class:kn(["option",{active:f[H[0]]===-1}]),onClick:$=>f[H[0]]=-1}," 不渲染 ",10,x2)]))),128)),k("div",w2,[k("div",{class:"action",onClick:A[0]||(A[0]=H=>Y(!0))},"恢复默认"),k("div",{class:"action",onClick:A[1]||(A[1]=H=>Y(!1))},"关闭渲染")])],4)])]),k("div",{id:"detail",onScroll:G},[(cn(!0),un(hn,null,Ue(Object.entries(xn(s)),([H,$])=>(cn(),un("div",{class:kn(["detail-card",d.value===H?"active":""]),ref_for:!0,ref:en=>xn(u)[H]=en,key:H},[Pt(Z(t(H))+" ",1),$.s3?(cn(),un("span",S2,"小发 "+Z($.s3),1)):me("",!0),$.s4?(cn(),un("span",C2,"轻微 "+Z($.s4),1)):me("",!0),$.hh?(cn(),un("span",T2,"恍惚 "+Z($.hh),1)):me("",!0),$.memo?(cn(),un("pre",O2,Z($.memo),1)):me("",!0),$.coner?(cn(),un("pre",E2,Z($.coner[1]),1)):me("",!0),k("pre",null,Z($.detail)+`

      `,1)],2))),128))],32)],64))}};s2(A2).mount("#app");
