...
20:06梦境，5不到，半分钟
22:00 洗好澡, 被压掉的有
23:19小哈刷牙的时候，5，6分，不轻不重，梦境为主，橡胶压掉了，时间和之前差不多`,hh:[7,8,15,17,18,19,20,23],s3:1,s4:2}},f3={id:"cont-wrap"},d3={id:"calender-wrap"},h3={id:"calender-head"},u3={class:"calender-year"},p3={class:"tag s3"},g3={class:"tag s4"},m3={class:"tag hh"},_3=["data-ts","onClick"],y3={class:"date"},b3=["data-theme","onClick","title"],v3={class:"opt-head"},x3=["onClick"],S3=["onClick"],w3={class:"strat setall"},C3=["onClick"],T3={class:"detail-header"},O3={class:"detail-date"},E3={class:"detail-tags"},P3={key:0,class:"tag s3"},R3={key:1,class:"tag s4"},A3={key:2,class:"tag hh"},D3={key:0,class:"detail-memo"},M3={key:1,class:"detail-coner"},I3={class:"detail-detail"},F3={__name:"App",setup(n){const e={purple:{name:"紫色",primary:"#9966cc",primaryLight:"#f8f5ff",primaryDark:"#7a4fb5",accent:"#e0b3ff",secondary:"#b12bc7",bgSubtle:"#f3f0ff",highlight:"#ffd700"},blue:{name:"蓝色",primary:"#3b82f6",primaryLight:"#eff6ff",primaryDark:"#1d4ed8",accent:"#93c5fd",secondary:"#1e40af",bgSubtle:"#dbeafe",highlight:"#f97316"},red:{name:"红色",primary:"#ef4444",primaryLight:"#fef2f2",primaryDark:"#dc2626",accent:"#fca5a5",secondary:"#dc2626",bgSubtle:"#fee2e2",highlight:"#22c55e"},green:{name:"绿色",primary:"#10b981",primaryLight:"#ecfdf5",primaryDark:"#059669",accent:"#6ee7b7",secondary:"#047857",bgSubtle:"#d1fae5",highlight:"#f59e0b"},yellow:{name:"黄色",primary:"#f59e0b",primaryLight:"#fffbeb",primaryDark:"#d97706",accent:"#fcd34d",secondary:"#d97706",bgSubtle:"#fef3c7",highlight:"#8b5cf6"},black:{name:"黑色",primary:"#1f2937",primaryLight:"#f9fafb",primaryDark:"#111827",accent:"#6b7280",secondary:"#374151",bgSubtle:"#f3f4f6",highlight:"#fbbf24"},white:{name:"白色",primary:"#64748b",primaryLight:"#f8fafc",primaryDark:"#475569",accent:"#94a3b8",secondary:"#475569",bgSubtle:"#f1f5f9",highlight:"#f97316"}},t=$=>$<10?`0${$}`:$,s=$=>{const O=new Date(+$);return`${O.getFullYear()}-${t(O.getMonth()+1)}-${t(O.getDate())}`},i=Object.fromEntries(Object.entries(c3).map(([$,O])=>[new Date($).valueOf(),O])),l=["2024-01-27",s(Date.now()+864e5*21)],r=(new Date(l[1])-new Date(l[0]))/864e5,o=new Date(l[0]).valueOf(),c=c1(new Date(l[0]).valueOf()+864e5*4),h=F1(D0),d=c1(0);let p={};const w=$=>{d.value=$.toString(),c.value=+$;const O=p[$],C=document.querySelector("#detail");if(O&&C){const D=O.getBoundingClientRect(),L=C.getBoundingClientRect();if(D.top<L.top||D.bottom>L.bottom){const W=C.clientHeight,U=O.offsetHeight,Tn=D.top-L.top,kn=C.scrollTop+Tn-(W-U)/2;C.scrollTo({top:Math.max(0,kn),behavior:"smooth"})}}},T=$=>{d.value=$.toString(),c.value=+$,setTimeout(()=>{const O=document.querySelector(`.card[data-ts="${$}"]`),C=document.querySelector("#calander-body");if(O&&C){const D=O.getBoundingClientRect(),L=C.getBoundingClientRect();if(D.top<L.top||D.bottom>L.bottom){const W=O.offsetTop,U=C.clientHeight,Tn=O.offsetHeight,kn=W-(U-Tn)/2;C.scrollTo({top:kn,behavior:"smooth"})}}},0)};let j=0,H=null;const nn=c1(!0),k=$=>{if(!H){const O=$.target;nn.value=j>O.scrollTop,j=O.scrollTop;const C=new Date(l[0]).valueOf()+(new Date(l[1])-new Date(l[0]))/O.scrollHeight*(O.scrollTop+O.clientHeight/2);c.value=C,H=setTimeout(()=>{H=null},350)}},I=F1({s3:{days:0,count:0},s4:{days:0,count:0},hh:{days:0,count:0}});A1(c,()=>{const $=new Date(c.value).getMonth(),O=new Date(c.value).getFullYear();I.s3.days=0,I.s3.count=0,I.s4.days=0,I.s4.count=0,I.hh.days=0,I.hh.count=0;for(const[C,D]of Object.entries(i)){const L=new Date(+C);L.getMonth()===$&&L.getFullYear()===O&&(D.s3&&(I.s3.days++,I.s3.count+=D.s3),D.s4&&(I.s4.days++,I.s4.count+=D.s4),D.hh&&D.hh.length>0&&(I.hh.days++,I.hh.count+=D.hh.length))}});let Y=null;const R=$=>{Y||(nn.value=!1,Y=setTimeout(()=>{Y=null},350))},Z=$=>{for(const O in D0)["coner","memo","detail"].includes(O)||(h[O]=$?0:-1)},pn=c1(!1),xn=()=>{pn.value=!pn.value},Sn=c1(localStorage.getItem("selectedTheme")||"purple"),Rn=c1(!1),Nn=()=>{Rn.value=!Rn.value},Kn=$=>{Sn.value=$;const O=e[$],C=document.documentElement;C.style.setProperty("--theme-primary",O.primary),C.style.setProperty("--theme-primary-light",O.primaryLight),C.style.setProperty("--theme-primary-dark",O.primaryDark),C.style.setProperty("--theme-accent",O.accent),C.style.setProperty("--theme-secondary",O.secondary),C.style.setProperty("--theme-bg-subtle",O.bgSubtle),C.style.setProperty("--theme-highlight",O.highlight),$==="black"?(C.style.setProperty("--text-color-light","#f9fafb"),C.style.setProperty("--bg-hover","#374151")):(C.style.setProperty("--text-color-light","#333"),C.style.setProperty("--bg-hover",O.bgSubtle)),localStorage.setItem("selectedTheme",$),Rn.value=!1};return Y2(()=>{const $=document.querySelector("#calander-body");$.scroll(0,$.scrollHeight*(new Date-new Date(l[0]))/(new Date(l[1])-new Date(l[0]))-$.clientHeight),Kn(Sn.value),document.addEventListener("click",O=>{const C=document.querySelector("#strategy-select"),D=document.querySelector(".strategy-trigger"),L=document.querySelector("#theme-select"),W=document.querySelector(".theme-trigger");!(C!=null&&C.contains(O.target))&&!(D!=null&&D.contains(O.target))&&(pn.value=!1),!(L!=null&&L.contains(O.target))&&!(W!=null&&W.contains(O.target))&&(Rn.value=!1)})}),($,O)=>(rn(),fn(hn,null,[B("div",f3,[B("div",d3,[B("div",h3,[B("div",u3,[Me(en(new Date(c.value).getFullYear())+"年"+en(new Date(c.value).getMonth()+1)+"月 ",1),B("span",p3,en(I.s3.days)+"天, "+en(I.s3.count)+"次",1),B("span",g3,en(I.s4.days)+"天, "+en(I.s4.count)+"次",1),B("span",m3,en(I.hh.days)+"天, "+en(I.hh.count)+"次",1)]),O[2]||(O[2]=ws('<div class="calender-item">周日</div><div class="calender-item">周一</div><div class="calender-item">周二</div><div class="calender-item">周三</div><div class="calender-item">周四</div><div class="calender-item">周五</div><div class="calender-item">周六</div>',7))]),B("div",{id:"calander-body",onScroll:k},[(rn(),fn(hn,null,x1(r,C=>B("div",{class:Fn(["calender-item card",[{"current-month":new Date(wn(o)+C*864e5).getMonth()===new Date(c.value).getMonth(),active:d.value==wn(o)+C*864e5}]]),"data-ts":wn(o)+C*864e5,onClick:D=>w(wn(o)+C*864e5),key:C},[B("div",y3,en(new Date(wn(o)+C*864e5).getDate()),1),Pn(a3,{strategy:h,record:wn(i)[wn(o)+C*864e5]},null,8,["strategy","record"])],10,_3)),64))],32),B("div",{class:"strategy-trigger",onClick:xn},O[3]||(O[3]=[B("span",{style:{"font-size":"1.2rem"}},"⚙️",-1)])),B("div",{class:"theme-trigger",onClick:Nn},O[4]||(O[4]=[B("span",{style:{"font-size":"1.2rem"}},"🎨",-1)])),B("div",{id:"theme-select",class:Fn({visible:Rn.value})},[(rn(),fn(hn,null,x1(e,(C,D)=>B("div",{class:Fn(["theme-option",{active:Sn.value===D}]),key:D,"data-theme":D,onClick:L=>Kn(D),title:C.name},[B("div",{class:"theme-color",style:i2({backgroundColor:C.primary})},null,4)],10,b3)),64))],2),B("div",{id:"strategy-select",class:Fn({visible:pn.value})},[(rn(!0),fn(hn,null,x1(Object.entries(wn(I2)),C=>(rn(),fn("div",{class:"strat",key:C[0]},[B("div",v3,en(wn(r3)[C[0]]),1),(rn(!0),fn(hn,null,x1(C[1],(D,L)=>(rn(),fn("div",{class:Fn(["option",{active:L===h[C[0]]}]),onClick:W=>h[C[0]]=L,key:D.name},en(D.name),11,x3))),128)),B("div",{class:Fn(["option",{active:h[C[0]]===-1}]),onClick:D=>h[C[0]]=-1}," 不渲染 ",10,S3)]))),128)),B("div",w3,[B("div",{class:"action",onClick:O[0]||(O[0]=C=>Z(!0))},"恢复默认"),B("div",{class:"action",onClick:O[1]||(O[1]=C=>Z(!1))},"关闭渲染")])],2)])]),B("div",{id:"detail",onScroll:R},[(rn(!0),fn(hn,null,x1(Object.entries(wn(i)),([C,D])=>(rn(),fn("div",{class:Fn(["detail-card",d.value==C?"active":""]),ref_for:!0,ref:L=>wn(p)[C]=L,key:C,onClick:L=>T(C)},[B("div",T3,[B("span",O3,en(s(C)),1),B("span",E3,[D.s3?(rn(),fn("span",P3,"小发 "+en(D.s3),1)):w1("",!0),D.s4?(rn(),fn("span",R3,"轻微 "+en(D.s4),1)):w1("",!0),D.hh&&D.hh.length?(rn(),fn("span",A3,"恍惚 "+en(D.hh.length),1)):w1("",!0)])]),O[5]||(O[5]=B("hr",{class:"detail-divider"},null,-1)),D.memo?(rn(),fn("pre",D3,en(D.memo),1)):w1("",!0),D.coner?(rn(),fn("pre",M3,en(D.coner[1]),1)):w1("",!0),B("pre",I3,en(D.detail),1)],10,C3))),128))],32)],64))}};s3(F3).mount("#app");
