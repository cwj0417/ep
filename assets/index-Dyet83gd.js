...
* @license MIT
**//*! #__NO_SIDE_EFFECTS__ */function F2(n){const e=Object.create(null);for(const t of n.split(","))e[t]=1;return t=>t in e}const z={},dn=[],$1=()=>{},je=()=>!1,n2=n=>n.charCodeAt(0)===111&&n.charCodeAt(1)===110&&(n.charCodeAt(2)>122||n.charCodeAt(2)<97),H2=n=>n.startsWith("onUpdate:"),s1=Object.assign,$2=(n,e)=>{const t=n.indexOf(e);t>-1&&n.splice(t,1)},Ne=Object.prototype.hasOwnProperty,K=(n,e)=>Ne.call(n,e),M=Array.isArray,fn=n=>e2(n)==="[object Map]",M0=n=>e2(n)==="[object Set]",F=n=>typeof n=="function",Q=n=>typeof n=="string",z1=n=>typeof n=="symbol",X=n=>n!==null&&typeof n=="object",I0=n=>(X(n)||F(n))&&F(n.then)&&F(n.catch),F0=Object.prototype.toString,e2=n=>F0.call(n),We=n=>e2(n).slice(8,-1),H0=n=>e2(n)==="[object Object]",L2=n=>Q(n)&&n!=="NaN"&&n[0]!=="-"&&""+parseInt(n,10)===n,Tn=F2(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),t2=n=>{const e=Object.create(null);return t=>e[t]||(e[t]=n(t))},Be=/-(\w)/g,J1=t2(n=>n.replace(Be,(e,t)=>t?t.toUpperCase():"")),Ue=/\B([A-Z])/g,on=t2(n=>n.replace(Ue,"-$1").toLowerCase()),$0=t2(n=>n.charAt(0).toUpperCase()+n.slice(1)),d2=t2(n=>n?`on${$0(n)}`:""),G1=(n,e)=>!Object.is(n,e),f2=(n,...e)=>{for(let t=0;t<n.length;t++)n[t](...e)},L0=(n,e,t,s=!1)=>{Object.defineProperty(n,e,{configurable:!0,enumerable:!1,writable:s,value:t})},Ve=n=>{const e=parseFloat(n);return isNaN(e)?n:e};let i0;const s2=()=>i0||(i0=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function i2(n){if(M(n)){const e={};for(let t=0;t<n.length;t++){const s=n[t],i=Q(s)?Ye(s):i2(s);if(i)for(const l in i)e[l]=i[l]}return e}else if(Q(n)||X(n))return n}const Ke=/;(?![^(]*\))/g,ke=/:([^]+)/,qe=/\/\*[^]*?\*\//g;function Ye(n){const e={};return n.replace(qe,"").split(Ke).forEach(t=>{if(t){const s=t.split(ke);s.length>1&&(e[s[0].trim()]=s[1].trim())}}),e}function I1(n){let e="";if(Q(n))e=n;else if(M(n))for(let t=0;t<n.length;t++){const s=I1(n[t]);s&&(e+=s+" ")}else if(X(n))for(const t in n)n[t]&&(e+=t+" ");return e.trim()}const Ge="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",Je=F2(Ge);function j0(n){return!!n||n===""}const N0=n=>!!(n&&n.__v_isRef===!0),e1=n=>Q(n)?n:n==null?"":M(n)||X(n)&&(n.toString===F0||!F(n.toString))?N0(n)?e1(n.value):JSON.stringify(n,W0,2):String(n),W0=(n,e)=>N0(e)?W0(n,e.value):fn(e)?{[`Map(${e.size})`]:[...e.entries()].reduce((t,[s,i],l)=>(t[u2(s,l)+" =>"]=i,t),{})}:M0(e)?{[`Set(${e.size})`]:[...e.values()].map(t=>u2(t))}:z1(e)?u2(e):X(e)&&!M(e)&&!H0(e)?String(e):e,u2=(n,e="")=>{var t;return z1(n)?`Symbol(${(t=n.description)!=null?t:e})`:n};/**
* @vue/reactivity v3.5.13
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let _1;class ze{constructor(e=!1){this.detached=e,this._active=!0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=_1,!e&&_1&&(this.index=(_1.scopes||(_1.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].pause();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].resume();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].resume()}}run(e){if(this._active){const t=_1;try{return _1=this,e()}finally{_1=t}}}on(){_1=this}off(){_1=this.parent}stop(e){if(this._active){this._active=!1;let t,s;for(t=0,s=this.effects.length;t<s;t++)this.effects[t].stop();for(this.effects.length=0,t=0,s=this.cleanups.length;t<s;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,s=this.scopes.length;t<s;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function Xe(){return _1}let J;const p2=new WeakSet;class B0{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,_1&&_1.active&&_1.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,p2.has(this)&&(p2.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||V0(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,l0(this),K0(this);const e=J,t=O1;J=this,O1=!0;try{return this.fn()}finally{k0(this),J=e,O1=t,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)W2(e);this.deps=this.depsTail=void 0,l0(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?p2.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){S2(this)&&this.run()}get dirty(){return S2(this)}}let U0=0,On,En;function V0(n,e=!1){if(n.flags|=8,e){n.next=En,En=n;return}n.next=On,On=n}function j2(){U0++}function N2(){if(--U0>0)return;if(En){let e=En;for(En=void 0;e;){const t=e.next;e.next=void 0,e.flags&=-9,e=t}}let n;for(;On;){let e=On;for(On=void 0;e;){const t=e.next;if(e.next=void 0,e.flags&=-9,e.flags&1)try{e.trigger()}catch(s){n||(n=s)}e=t}}if(n)throw n}function K0(n){for(let e=n.deps;e;e=e.nextDep)e.version=-1,e.prevActiveLink=e.dep.activeLink,e.dep.activeLink=e}function k0(n){let e,t=n.depsTail,s=t;for(;s;){const i=s.prevDep;s.version===-1?(s===t&&(t=i),W2(s),Ze(s)):e=s,s.dep.activeLink=s.prevActiveLink,s.prevActiveLink=void 0,s=i}n.deps=e,n.depsTail=t}function S2(n){for(let e=n.deps;e;e=e.nextDep)if(e.dep.version!==e.version||e.dep.computed&&(q0(e.dep.computed)||e.dep.version!==e.version))return!0;return!!n._dirty}function q0(n){if(n.flags&4&&!(n.flags&16)||(n.flags&=-17,n.globalVersion===Mn))return;n.globalVersion=Mn;const e=n.dep;if(n.flags|=2,e.version>0&&!n.isSSR&&n.deps&&!S2(n)){n.flags&=-3;return}const t=J,s=O1;J=n,O1=!0;try{K0(n);const i=n.fn(n._value);(e.version===0||G1(i,n._value))&&(n._value=i,e.version++)}catch(i){throw e.version++,i}finally{J=t,O1=s,k0(n),n.flags&=-3}}function W2(n,e=!1){const{dep:t,prevSub:s,nextSub:i}=n;if(s&&(s.nextSub=i,n.prevSub=void 0),i&&(i.prevSub=s,n.nextSub=void 0),t.subs===n&&(t.subs=s,!s&&t.computed)){t.computed.flags&=-5;for(let l=t.computed.deps;l;l=l.nextDep)W2(l,!0)}!e&&!--t.sc&&t.map&&t.map.delete(t.key)}function Ze(n){const{prevDep:e,nextDep:t}=n;e&&(e.nextDep=t,n.prevDep=void 0),t&&(t.prevDep=e,n.nextDep=void 0)}let O1=!0;const Y0=[];function X1(){Y0.push(O1),O1=!1}function Z1(){const n=Y0.pop();O1=n===void 0?!0:n}function l0(n){const{cleanup:e}=n;if(n.cleanup=void 0,e){const t=J;J=void 0;try{e()}finally{J=t}}}let Mn=0;class Qe{constructor(e,t){this.sub=e,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class B2{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0}track(e){if(!J||!O1||J===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==J)t=this.activeLink=new Qe(J,this),J.deps?(t.prevDep=J.depsTail,J.depsTail.nextDep=t,J.depsTail=t):J.deps=J.depsTail=t,G0(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){const s=t.nextDep;s.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=s),t.prevDep=J.depsTail,t.nextDep=void 0,J.depsTail.nextDep=t,J.depsTail=t,J.deps===t&&(J.deps=s)}return t}trigger(e){this.version++,Mn++,this.notify(e)}notify(e){j2();try{for(let t=this.subs;t;t=t.prevSub)t.sub.notify()&&t.sub.dep.notify()}finally{N2()}}}function G0(n){if(n.dep.sc++,n.sub.flags&4){const e=n.dep.computed;if(e&&!n.dep.subs){e.flags|=20;for(let s=e.deps;s;s=s.nextDep)G0(s)}const t=n.dep.subs;t!==n&&(n.prevSub=t,t&&(t.nextSub=n)),n.dep.subs=n}}const w2=new WeakMap,sn=Symbol(""),C2=Symbol(""),In=Symbol("");function r1(n,e,t){if(O1&&J){let s=w2.get(n);s||w2.set(n,s=new Map);let i=s.get(t);i||(s.set(t,i=new B2),i.map=s,i.key=t),i.track()}}function B1(n,e,t,s,i,l){const r=w2.get(n);if(!r){Mn++;return}const o=h=>{h&&h.trigger()};if(j2(),e==="clear")r.forEach(o);else{const h=M(n),f=h&&L2(t);if(h&&t==="length"){const d=Number(s);r.forEach((p,w)=>{(w==="length"||w===In||!z1(w)&&w>=d)&&o(p)})}else switch((t!==void 0||r.has(void 0))&&o(r.get(t)),f&&o(r.get(In)),e){case"add":h?f&&o(r.get("length")):(o(r.get(sn)),fn(n)&&o(r.get(C2)));break;case"delete":h||(o(r.get(sn)),fn(n)&&o(r.get(C2)));break;case"set":fn(n)&&o(r.get(sn));break}}N2()}function an(n){const e=V(n);return e===n?e:(r1(e,"iterate",In),w1(n)?e:e.map(o1))}function l2(n){return r1(n=V(n),"iterate",In),n}const nt={__proto__:null,[Symbol.iterator](){return m2(this,Symbol.iterator,o1)},concat(...n){return an(this).concat(...n.map(e=>M(e)?an(e):e))},entries(){return m2(this,"entries",n=>(n[1]=o1(n[1]),n))},every(n,e){return N1(this,"every",n,e,void 0,arguments)},filter(n,e){return N1(this,"filter",n,e,t=>t.map(o1),arguments)},find(n,e){return N1(this,"find",n,e,o1,arguments)},findIndex(n,e){return N1(this,"findIndex",n,e,void 0,arguments)},findLast(n,e){return N1(this,"findLast",n,e,o1,arguments)},findLastIndex(n,e){return N1(this,"findLastIndex",n,e,void 0,arguments)},forEach(n,e){return N1(this,"forEach",n,e,void 0,arguments)},includes(...n){return g2(this,"includes",n)},indexOf(...n){return g2(this,"indexOf",n)},join(n){return an(this).join(n)},lastIndexOf(...n){return g2(this,"lastIndexOf",n)},map(n,e){return N1(this,"map",n,e,void 0,arguments)},pop(){return vn(this,"pop")},push(...n){return vn(this,"push",n)},reduce(n,...e){return r0(this,"reduce",n,e)},reduceRight(n,...e){return r0(this,"reduceRight",n,e)},shift(){return vn(this,"shift")},some(n,e){return N1(this,"some",n,e,void 0,arguments)},splice(...n){return vn(this,"splice",n)},toReversed(){return an(this).toReversed()},toSorted(n){return an(this).toSorted(n)},toSpliced(...n){return an(this).toSpliced(...n)},unshift(...n){return vn(this,"unshift",n)},values(){return m2(this,"values",o1)}};function m2(n,e,t){const s=l2(n),i=s[e]();return s!==n&&!w1(n)&&(i._next=i.next,i.next=()=>{const l=i._next();return l.value&&(l.value=t(l.value)),l}),i}const et=Array.prototype;function N1(n,e,t,s,i,l){const r=l2(n),o=r!==n&&!w1(n),h=r[e];if(h!==et[e]){const p=h.apply(n,l);return o?o1(p):p}let f=t;r!==n&&(o?f=function(p,w){return t.call(this,o1(p),w,n)}:t.length>2&&(f=function(p,w){return t.call(this,p,w,n)}));const d=h.call(r,f,s);return o&&i?i(d):d}function r0(n,e,t,s){const i=l2(n);let l=t;return i!==n&&(w1(n)?t.length>3&&(l=function(r,o,h){return t.call(this,r,o,h,n)}):l=function(r,o,h){return t.call(this,r,o1(o),h,n)}),i[e](l,...s)}function g2(n,e,t){const s=V(n);r1(s,"iterate",In);const i=s[e](...t);return(i===-1||i===!1)&&K2(t[0])?(t[0]=V(t[0]),s[e](...t)):i}function vn(n,e,t=[]){X1(),j2();const s=V(n)[e].apply(n,t);return N2(),Z1(),s}const tt=F2("__proto__,__v_isRef,__isVue"),J0=new Set(Object.getOwnPropertyNames(Symbol).filter(n=>n!=="arguments"&&n!=="caller").map(n=>Symbol[n]).filter(z1));function st(n){z1(n)||(n=String(n));const e=V(this);return r1(e,"has",n),e.hasOwnProperty(n)}class z0{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,s){if(t==="__v_skip")return e.__v_skip;const i=this._isReadonly,l=this._isShallow;if(t==="__v_isReactive")return!i;if(t==="__v_isReadonly")return i;if(t==="__v_isShallow")return l;if(t==="__v_raw")return s===(i?l?ut:ne:l?Q0:Z0).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(s)?e:void 0;const r=M(e);if(!i){let h;if(r&&(h=nt[t]))return h;if(t==="hasOwnProperty")return st}const o=Reflect.get(e,t,t1(e)?e:s);return(z1(t)?J0.has(t):tt(t))||(i||r1(e,"get",t),l)?o:t1(o)?r&&L2(t)?o:o.value:X(o)?i?ee(o):Fn(o):o}}class X0 extends z0{constructor(e=!1){super(!1,e)}set(e,t,s,i){let l=e[t];if(!this._isShallow){const h=ln(l);if(!w1(s)&&!ln(s)&&(l=V(l),s=V(s)),!M(e)&&t1(l)&&!t1(s))return h?!1:(l.value=s,!0)}const r=M(e)&&L2(t)?Number(t)<e.length:K(e,t),o=Reflect.set(e,t,s,t1(e)?e:i);return e===V(i)&&(r?G1(s,l)&&B1(e,"set",t,s):B1(e,"add",t,s)),o}deleteProperty(e,t){const s=K(e,t);e[t];const i=Reflect.deleteProperty(e,t);return i&&s&&B1(e,"delete",t,void 0),i}has(e,t){const s=Reflect.has(e,t);return(!z1(t)||!J0.has(t))&&r1(e,"has",t),s}ownKeys(e){return r1(e,"iterate",M(e)?"length":sn),Reflect.ownKeys(e)}}class it extends z0{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}}const lt=new X0,rt=new it,ot=new X0(!0);const T2=n=>n,Bn=n=>Reflect.getPrototypeOf(n);function at(n,e,t){return function(...s){const i=this.__v_raw,l=V(i),r=fn(l),o=n==="entries"||n===Symbol.iterator&&r,h=n==="keys"&&r,f=i[n](...s),d=t?T2:e?O2:o1;return!e&&r1(l,"iterate",h?C2:sn),{next(){const{value:p,done:w}=f.next();return w?{value:p,done:w}:{value:o?[d(p[0]),d(p[1])]:d(p),done:w}},[Symbol.iterator](){return this}}}}function Un(n){return function(...e){return n==="delete"?!1:n==="clear"?void 0:this}}function ht(n,e){const t={get(i){const l=this.__v_raw,r=V(l),o=V(i);n||(G1(i,o)&&r1(r,"get",i),r1(r,"get",o));const{has:h}=Bn(r),f=e?T2:n?O2:o1;if(h.call(r,i))return f(l.get(i));if(h.call(r,o))return f(l.get(o));l!==r&&l.get(i)},get size(){const i=this.__v_raw;return!n&&r1(V(i),"iterate",sn),Reflect.get(i,"size",i)},has(i){const l=this.__v_raw,r=V(l),o=V(i);return n||(G1(i,o)&&r1(r,"has",i),r1(r,"has",o)),i===o?l.has(i):l.has(i)||l.has(o)},forEach(i,l){const r=this,o=r.__v_raw,h=V(o),f=e?T2:n?O2:o1;return!n&&r1(h,"iterate",sn),o.forEach((d,p)=>i.call(l,f(d),f(p),r))}};return s1(t,n?{add:Un("add"),set:Un("set"),delete:Un("delete"),clear:Un("clear")}:{add(i){!e&&!w1(i)&&!ln(i)&&(i=V(i));const l=V(this);return Bn(l).has.call(l,i)||(l.add(i),B1(l,"add",i,i)),this},set(i,l){!e&&!w1(l)&&!ln(l)&&(l=V(l));const r=V(this),{has:o,get:h}=Bn(r);let f=o.call(r,i);f||(i=V(i),f=o.call(r,i));const d=h.call(r,i);return r.set(i,l),f?G1(l,d)&&B1(r,"set",i,l):B1(r,"add",i,l),this},delete(i){const l=V(this),{has:r,get:o}=Bn(l);let h=r.call(l,i);h||(i=V(i),h=r.call(l,i)),o&&o.call(l,i);const f=l.delete(i);return h&&B1(l,"delete",i,void 0),f},clear(){const i=V(this),l=i.size!==0,r=i.clear();return l&&B1(i,"clear",void 0,void 0),r}}),["keys","values","entries",Symbol.iterator].forEach(i=>{t[i]=at(i,n,e)}),t}function U2(n,e){const t=ht(n,e);return(s,i,l)=>i==="__v_isReactive"?!n:i==="__v_isReadonly"?n:i==="__v_raw"?s:Reflect.get(K(t,i)&&i in s?t:s,i,l)}const ct={get:U2(!1,!1)},dt={get:U2(!1,!0)},ft={get:U2(!0,!1)};const Z0=new WeakMap,Q0=new WeakMap,ne=new WeakMap,ut=new WeakMap;function pt(n){switch(n){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function mt(n){return n.__v_skip||!Object.isExtensible(n)?0:pt(We(n))}function Fn(n){return ln(n)?n:V2(n,!1,lt,ct,Z0)}function gt(n){return V2(n,!1,ot,dt,Q0)}function ee(n){return V2(n,!0,rt,ft,ne)}function V2(n,e,t,s,i){if(!X(n)||n.__v_raw&&!(e&&n.__v_isReactive))return n;const l=i.get(n);if(l)return l;const r=mt(n);if(r===0)return n;const o=new Proxy(n,r===2?s:t);return i.set(n,o),o}function un(n){return ln(n)?un(n.__v_raw):!!(n&&n.__v_isReactive)}function ln(n){return!!(n&&n.__v_isReadonly)}function w1(n){return!!(n&&n.__v_isShallow)}function K2(n){return n?!!n.__v_raw:!1}function V(n){const e=n&&n.__v_raw;return e?V(e):n}function yt(n){return!K(n,"__v_skip")&&Object.isExtensible(n)&&L0(n,"__v_skip",!0),n}const o1=n=>X(n)?Fn(n):n,O2=n=>X(n)?ee(n):n;function t1(n){return n?n.__v_isRef===!0:!1}function hn(n){return _t(n,!1)}function _t(n,e){return t1(n)?n:new bt(n,e)}class bt{constructor(e,t){this.dep=new B2,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?e:V(e),this._value=t?e:o1(e),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(e){const t=this._rawValue,s=this.__v_isShallow||w1(e)||ln(e);e=s?e:V(e),G1(e,t)&&(this._rawValue=e,this._value=s?e:o1(e),this.dep.trigger())}}function S1(n){return t1(n)?n.value:n}const vt={get:(n,e,t)=>e==="__v_raw"?n:S1(Reflect.get(n,e,t)),set:(n,e,t,s)=>{const i=n[e];return t1(i)&&!t1(t)?(i.value=t,!0):Reflect.set(n,e,t,s)}};function te(n){return un(n)?n:new Proxy(n,vt)}class xt{constructor(e,t,s){this.fn=e,this.setter=t,this._value=void 0,this.dep=new B2(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Mn-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=s}notify(){if(this.flags|=16,!(this.flags&8)&&J!==this)return V0(this,!0),!0}get value(){const e=this.dep.track();return q0(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}}function St(n,e,t=!1){let s,i;return F(n)?s=n:(s=n.get,i=n.set),new xt(s,i,t)}const Vn={},Gn=new WeakMap;let tn;function wt(n,e=!1,t=tn){if(t){let s=Gn.get(t);s||Gn.set(t,s=[]),s.push(n)}}function Ct(n,e,t=z){const{immediate:s,deep:i,once:l,scheduler:r,augmentJob:o,call:h}=t,f=R=>i?R:w1(R)||i===!1||i===0?Y1(R,1):Y1(R);let d,p,w,T,j=!1,H=!1;if(t1(n)?(p=()=>n.value,j=w1(n)):un(n)?(p=()=>f(n),j=!0):M(n)?(H=!0,j=n.some(R=>un(R)||w1(R)),p=()=>n.map(R=>{if(t1(R))return R.value;if(un(R))return f(R);if(F(R))return h?h(R,2):R()})):F(n)?e?p=h?()=>h(n,2):n:p=()=>{if(w){X1();try{w()}finally{Z1()}}const R=tn;tn=d;try{return h?h(n,3,[T]):n(T)}finally{tn=R}}:p=$1,e&&i){const R=p,Z=i===!0?1/0:i;p=()=>Y1(R(),Z)}const n1=Xe(),k=()=>{d.stop(),n1&&n1.active&&$2(n1.effects,d)};if(l&&e){const R=e;e=(...Z)=>{R(...Z),k()}}let I=H?new Array(n.length).fill(Vn):Vn;const Y=R=>{if(!(!(d.flags&1)||!d.dirty&&!R))if(e){const Z=d.run();if(i||j||(H?Z.some((u1,v1)=>G1(u1,I[v1])):G1(Z,I))){w&&w();const u1=tn;tn=d;try{const v1=[Z,I===Vn?void 0:H&&I[0]===Vn?[]:I,T];h?h(e,3,v1):e(...v1),I=Z}finally{tn=u1}}}else d.run()};return o&&o(Y),d=new B0(p),d.scheduler=r?()=>r(Y,!1):Y,T=R=>wt(R,!1,d),w=d.onStop=()=>{const R=Gn.get(d);if(R){if(h)h(R,4);else for(const Z of R)Z();Gn.delete(d)}},e?s?Y(!0):I=d.run():r?r(Y.bind(null,!0),!0):d.run(),k.pause=d.pause.bind(d),k.resume=d.resume.bind(d),k.stop=k,k}function Y1(n,e=1/0,t){if(e<=0||!X(n)||n.__v_skip||(t=t||new Set,t.has(n)))return n;if(t.add(n),e--,t1(n))Y1(n.value,e,t);else if(M(n))for(let s=0;s<n.length;s++)Y1(n[s],e,t);else if(M0(n)||fn(n))n.forEach(s=>{Y1(s,e,t)});else if(H0(n)){for(const s in n)Y1(n[s],e,t);for(const s of Object.getOwnPropertySymbols(n))Object.prototype.propertyIsEnumerable.call(n,s)&&Y1(n[s],e,t)}return n}/**
* @vue/runtime-core v3.5.13
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function jn(n,e,t,s){try{return s?n(...s):n()}catch(i){r2(i,e,t)}}function L1(n,e,t,s){if(F(n)){const i=jn(n,e,t,s);return i&&I0(i)&&i.catch(l=>{r2(l,e,t)}),i}if(M(n)){const i=[];for(let l=0;l<n.length;l++)i.push(L1(n[l],e,t,s));return i}}function r2(n,e,t,s=!0){const i=e?e.vnode:null,{errorHandler:l,throwUnhandledErrorInProduction:r}=e&&e.appContext.config||z;if(e){let o=e.parent;const h=e.proxy,f=`https://vuejs.org/error-reference/#runtime-${t}`;for(;o;){const d=o.ec;if(d){for(let p=0;p<d.length;p++)if(d[p](n,h,f)===!1)return}o=o.parent}if(l){X1(),jn(l,null,10,[n,h,f]),Z1();return}}Tt(n,t,i,s,r)}function Tt(n,e,t,s=!0,i=!1){if(i)throw n;console.error(n)}const c1=[];let M1=-1;const pn=[];let k1=null,cn=0;const se=Promise.resolve();let Jn=null;function Ot(n){const e=Jn||se;return n?e.then(this?n.bind(this):n):e}function Et(n){let e=M1+1,t=c1.length;for(;e<t;){const s=e+t>>>1,i=c1[s],l=Hn(i);l<n||l===n&&i.flags&2?e=s+1:t=s}return e}function k2(n){if(!(n.flags&1)){const e=Hn(n),t=c1[c1.length-1];!t||!(n.flags&2)&&e>=Hn(t)?c1.push(n):c1.splice(Et(e),0,n),n.flags|=1,ie()}}function ie(){Jn||(Jn=se.then(re))}function Pt(n){M(n)?pn.push(...n):k1&&n.id===-1?k1.splice(cn+1,0,n):n.flags&1||(pn.push(n),n.flags|=1),ie()}function o0(n,e,t=M1+1){for(;t<c1.length;t++){const s=c1[t];if(s&&s.flags&2){if(n&&s.id!==n.uid)continue;c1.splice(t,1),t--,s.flags&4&&(s.flags&=-2),s(),s.flags&4||(s.flags&=-2)}}}function le(n){if(pn.length){const e=[...new Set(pn)].sort((t,s)=>Hn(t)-Hn(s));if(pn.length=0,k1){k1.push(...e);return}for(k1=e,cn=0;cn<k1.length;cn++){const t=k1[cn];t.flags&4&&(t.flags&=-2),t.flags&8||t(),t.flags&=-2}k1=null,cn=0}}const Hn=n=>n.id==null?n.flags&2?-1:1/0:n.id;function re(n){try{for(M1=0;M1<c1.length;M1++){const e=c1[M1];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),jn(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;M1<c1.length;M1++){const e=c1[M1];e&&(e.flags&=-2)}M1=-1,c1.length=0,le(),Jn=null,(c1.length||pn.length)&&re()}}let H1=null,oe=null;function zn(n){const e=H1;return H1=n,oe=n&&n.type.__scopeId||null,e}function Rt(n,e=H1,t){if(!e||n._n)return n;const s=(...i)=>{s._d&&m0(-1);const l=zn(e);let r;try{r=n(...i)}finally{zn(l),s._d&&m0(1)}return r};return s._n=!0,s._c=!0,s._d=!0,s}function nn(n,e,t,s){const i=n.dirs,l=e&&e.dirs;for(let r=0;r<i.length;r++){const o=i[r];l&&(o.oldValue=l[r].value);let h=o.dir[s];h&&(X1(),L1(h,t,8,[n.el,o,n,e]),Z1())}}const At=Symbol("_vte"),Dt=n=>n.__isTeleport;function q2(n,e){n.shapeFlag&6&&n.component?(n.transition=e,q2(n.component.subTree,e)):n.shapeFlag&128?(n.ssContent.transition=e.clone(n.ssContent),n.ssFallback.transition=e.clone(n.ssFallback)):n.transition=e}function ae(n){n.ids=[n.ids[0]+n.ids[2]+++"-",0,0]}function Xn(n,e,t,s,i=!1){if(M(n)){n.forEach((j,H)=>Xn(j,e&&(M(e)?e[H]:e),t,s,i));return}if(Pn(s)&&!i){s.shapeFlag&512&&s.type.__asyncResolved&&s.component.subTree.component&&Xn(n,e,t,s.component.subTree);return}const l=s.shapeFlag&4?X2(s.component):s.el,r=i?null:l,{i:o,r:h}=n,f=e&&e.r,d=o.refs===z?o.refs={}:o.refs,p=o.setupState,w=V(p),T=p===z?()=>!1:j=>K(w,j);if(f!=null&&f!==h&&(Q(f)?(d[f]=null,T(f)&&(p[f]=null)):t1(f)&&(f.value=null)),F(h))jn(h,o,12,[r,d]);else{const j=Q(h),H=t1(h);if(j||H){const n1=()=>{if(n.f){const k=j?T(h)?p[h]:d[h]:h.value;i?M(k)&&$2(k,l):M(k)?k.includes(l)||k.push(l):j?(d[h]=[l],T(h)&&(p[h]=d[h])):(h.value=[l],n.k&&(d[n.k]=h.value))}else j?(d[h]=r,T(h)&&(p[h]=r)):H&&(h.value=r,n.k&&(d[n.k]=r))};r?(n1.id=-1,y1(n1,t)):n1()}}}s2().requestIdleCallback;s2().cancelIdleCallback;const Pn=n=>!!n.type.__asyncLoader,he=n=>n.type.__isKeepAlive;function Mt(n,e){ce(n,"a",e)}function It(n,e){ce(n,"da",e)}function ce(n,e,t=f1){const s=n.__wdc||(n.__wdc=()=>{let i=t;for(;i;){if(i.isDeactivated)return;i=i.parent}return n()});if(o2(e,s,t),t){let i=t.parent;for(;i&&i.parent;)he(i.parent.vnode)&&Ft(s,e,t,i),i=i.parent}}function Ft(n,e,t,s){const i=o2(e,n,s,!0);de(()=>{$2(s[e],i)},t)}function o2(n,e,t=f1,s=!1){if(t){const i=t[n]||(t[n]=[]),l=e.__weh||(e.__weh=(...r)=>{X1();const o=Nn(t),h=L1(e,t,n,r);return o(),Z1(),h});return s?i.unshift(l):i.push(l),l}}const U1=n=>(e,t=f1)=>{(!Ln||n==="sp")&&o2(n,(...s)=>e(...s),t)},Ht=U1("bm"),Y2=U1("m"),$t=U1("bu"),Lt=U1("u"),jt=U1("bum"),de=U1("um"),Nt=U1("sp"),Wt=U1("rtg"),Bt=U1("rtc");function Ut(n,e=f1){o2("ec",n,e)}const Vt=Symbol.for("v-ndc");function xn(n,e,t,s){let i;const l=t,r=M(n);if(r||Q(n)){const o=r&&un(n);let h=!1;o&&(h=!w1(n),n=l2(n)),i=new Array(n.length);for(let f=0,d=n.length;f<d;f++)i[f]=e(h?o1(n[f]):n[f],f,void 0,l)}else if(typeof n=="number"){i=new Array(n);for(let o=0;o<n;o++)i[o]=e(o+1,o,void 0,l)}else if(X(n))if(n[Symbol.iterator])i=Array.from(n,(o,h)=>e(o,h,void 0,l));else{const o=Object.keys(n);i=new Array(o.length);for(let h=0,f=o.length;h<f;h++){const d=o[h];i[h]=e(n[d],d,h,l)}}else i=[];return i}const E2=n=>n?Ie(n)?X2(n):E2(n.parent):null,Rn=s1(Object.create(null),{$:n=>n,$el:n=>n.vnode.el,$data:n=>n.data,$props:n=>n.props,$attrs:n=>n.attrs,$slots:n=>n.slots,$refs:n=>n.refs,$parent:n=>E2(n.parent),$root:n=>E2(n.root),$host:n=>n.ce,$emit:n=>n.emit,$options:n=>G2(n),$forceUpdate:n=>n.f||(n.f=()=>{k2(n.update)}),$nextTick:n=>n.n||(n.n=Ot.bind(n.proxy)),$watch:n=>d3.bind(n)}),y2=(n,e)=>n!==z&&!n.__isScriptSetup&&K(n,e),Kt={get({_:n},e){if(e==="__v_skip")return!0;const{ctx:t,setupState:s,data:i,props:l,accessCache:r,type:o,appContext:h}=n;let f;if(e[0]!=="$"){const T=r[e];if(T!==void 0)switch(T){case 1:return s[e];case 2:return i[e];case 4:return t[e];case 3:return l[e]}else{if(y2(s,e))return r[e]=1,s[e];if(i!==z&&K(i,e))return r[e]=2,i[e];if((f=n.propsOptions[0])&&K(f,e))return r[e]=3,l[e];if(t!==z&&K(t,e))return r[e]=4,t[e];P2&&(r[e]=0)}}const d=Rn[e];let p,w;if(d)return e==="$attrs"&&r1(n.attrs,"get",""),d(n);if((p=o.__cssModules)&&(p=p[e]))return p;if(t!==z&&K(t,e))return r[e]=4,t[e];if(w=h.config.globalProperties,K(w,e))return w[e]},set({_:n},e,t){const{data:s,setupState:i,ctx:l}=n;return y2(i,e)?(i[e]=t,!0):s!==z&&K(s,e)?(s[e]=t,!0):K(n.props,e)||e[0]==="$"&&e.slice(1)in n?!1:(l[e]=t,!0)},has({_:{data:n,setupState:e,accessCache:t,ctx:s,appContext:i,propsOptions:l}},r){let o;return!!t[r]||n!==z&&K(n,r)||y2(e,r)||(o=l[0])&&K(o,r)||K(s,r)||K(Rn,r)||K(i.config.globalProperties,r)},defineProperty(n,e,t){return t.get!=null?n._.accessCache[e]=0:K(t,"value")&&this.set(n,e,t.value,null),Reflect.defineProperty(n,e,t)}};function a0(n){return M(n)?n.reduce((e,t)=>(e[t]=null,e),{}):n}let P2=!0;function kt(n){const e=G2(n),t=n.proxy,s=n.ctx;P2=!1,e.beforeCreate&&h0(e.beforeCreate,n,"bc");const{data:i,computed:l,methods:r,watch:o,provide:h,inject:f,created:d,beforeMount:p,mounted:w,beforeUpdate:T,updated:j,activated:H,deactivated:n1,beforeDestroy:k,beforeUnmount:I,destroyed:Y,unmounted:R,render:Z,renderTracked:u1,renderTriggered:v1,errorCaptured:x1,serverPrefetch:P1,expose:j1,inheritAttrs:V1,components:$,directives:O,filters:C}=e;if(f&&qt(f,s,null),r)for(const W in r){const U=r[W];F(U)&&(s[W]=U.bind(t))}if(i){const W=i.call(t,t);X(W)&&(n.data=Fn(W))}if(P2=!0,l)for(const W in l){const U=l[W],C1=F(U)?U.bind(t,t):F(U.get)?U.get.bind(t,t):$1,K1=!F(U)&&F(U.set)?U.set.bind(t):$1,Q1=I3({get:C1,set:K1});Object.defineProperty(s,W,{enumerable:!0,configurable:!0,get:()=>Q1.value,set:R1=>Q1.value=R1})}if(o)for(const W in o)fe(o[W],s,t,W);if(h){const W=F(h)?h.call(t):h;Reflect.ownKeys(W).forEach(U=>{Zt(U,W[U])})}d&&h0(d,n,"c");function L(W,U){M(U)?U.forEach(C1=>W(C1.bind(t))):U&&W(U.bind(t))}if(L(Ht,p),L(Y2,w),L($t,T),L(Lt,j),L(Mt,H),L(It,n1),L(Ut,x1),L(Bt,u1),L(Wt,v1),L(jt,I),L(de,R),L(Nt,P1),M(j1))if(j1.length){const W=n.exposed||(n.exposed={});j1.forEach(U=>{Object.defineProperty(W,U,{get:()=>t[U],set:C1=>t[U]=C1})})}else n.exposed||(n.exposed={});Z&&n.render===$1&&(n.render=Z),V1!=null&&(n.inheritAttrs=V1),$&&(n.components=$),O&&(n.directives=O),P1&&ae(n)}function qt(n,e,t=$1){M(n)&&(n=R2(n));for(const s in n){const i=n[s];let l;X(i)?"default"in i?l=Kn(i.from||s,i.default,!0):l=Kn(i.from||s):l=Kn(i),t1(l)?Object.defineProperty(e,s,{enumerable:!0,configurable:!0,get:()=>l.value,set:r=>l.value=r}):e[s]=l}}function h0(n,e,t){L1(M(n)?n.map(s=>s.bind(e.proxy)):n.bind(e.proxy),e,t)}function fe(n,e,t,s){let i=s.includes(".")?Oe(t,s):()=>t[s];if(Q(n)){const l=e[n];F(l)&&An(i,l)}else if(F(n))An(i,n.bind(t));else if(X(n))if(M(n))n.forEach(l=>fe(l,e,t,s));else{const l=F(n.handler)?n.handler.bind(t):e[n.handler];F(l)&&An(i,l,n)}}function G2(n){const e=n.type,{mixins:t,extends:s}=e,{mixins:i,optionsCache:l,config:{optionMergeStrategies:r}}=n.appContext,o=l.get(e);let h;return o?h=o:!i.length&&!t&&!s?h=e:(h={},i.length&&i.forEach(f=>Zn(h,f,r,!0)),Zn(h,e,r)),X(e)&&l.set(e,h),h}function Zn(n,e,t,s=!1){const{mixins:i,extends:l}=e;l&&Zn(n,l,t,!0),i&&i.forEach(r=>Zn(n,r,t,!0));for(const r in e)if(!(s&&r==="expose")){const o=Yt[r]||t&&t[r];n[r]=o?o(n[r],e[r]):e[r]}return n}const Yt={data:c0,props:d0,emits:d0,methods:Cn,computed:Cn,beforeCreate:a1,created:a1,beforeMount:a1,mounted:a1,beforeUpdate:a1,updated:a1,beforeDestroy:a1,beforeUnmount:a1,destroyed:a1,unmounted:a1,activated:a1,deactivated:a1,errorCaptured:a1,serverPrefetch:a1,components:Cn,directives:Cn,watch:Jt,provide:c0,inject:Gt};function c0(n,e){return e?n?function(){return s1(F(n)?n.call(this,this):n,F(e)?e.call(this,this):e)}:e:n}function Gt(n,e){return Cn(R2(n),R2(e))}function R2(n){if(M(n)){const e={};for(let t=0;t<n.length;t++)e[n[t]]=n[t];return e}return n}function a1(n,e){return n?[...new Set([].concat(n,e))]:e}function Cn(n,e){return n?s1(Object.create(null),n,e):e}function d0(n,e){return n?M(n)&&M(e)?[...new Set([...n,...e])]:s1(Object.create(null),a0(n),a0(e??{})):e}function Jt(n,e){if(!n)return e;if(!e)return n;const t=s1(Object.create(null),n);for(const s in e)t[s]=a1(n[s],e[s]);return t}function ue(){return{app:null,config:{isNativeTag:je,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let zt=0;function Xt(n,e){return function(s,i=null){F(s)||(s=s1({},s)),i!=null&&!X(i)&&(i=null);const l=ue(),r=new WeakSet,o=[];let h=!1;const f=l.app={_uid:zt++,_component:s,_props:i,_container:null,_context:l,_instance:null,version:F3,get config(){return l.config},set config(d){},use(d,...p){return r.has(d)||(d&&F(d.install)?(r.add(d),d.install(f,...p)):F(d)&&(r.add(d),d(f,...p))),f},mixin(d){return l.mixins.includes(d)||l.mixins.push(d),f},component(d,p){return p?(l.components[d]=p,f):l.components[d]},directive(d,p){return p?(l.directives[d]=p,f):l.directives[d]},mount(d,p,w){if(!h){const T=f._ceVNode||E1(s,i);return T.appContext=l,w===!0?w="svg":w===!1&&(w=void 0),p&&e?e(T,d):n(T,d,w),h=!0,f._container=d,d.__vue_app__=f,X2(T.component)}},onUnmount(d){o.push(d)},unmount(){h&&(L1(o,f._instance,16),n(null,f._container),delete f._container.__vue_app__)},provide(d,p){return l.provides[d]=p,f},runWithContext(d){const p=mn;mn=f;try{return d()}finally{mn=p}}};return f}}let mn=null;function Zt(n,e){if(f1){let t=f1.provides;const s=f1.parent&&f1.parent.provides;s===t&&(t=f1.provides=Object.create(s)),t[n]=e}}function Kn(n,e,t=!1){const s=f1||H1;if(s||mn){const i=mn?mn._context.provides:s?s.parent==null?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:void 0;if(i&&n in i)return i[n];if(arguments.length>1)return t&&F(e)?e.call(s&&s.proxy):e}}const pe={},me=()=>Object.create(pe),ge=n=>Object.getPrototypeOf(n)===pe;function Qt(n,e,t,s=!1){const i={},l=me();n.propsDefaults=Object.create(null),ye(n,e,i,l);for(const r in n.propsOptions[0])r in i||(i[r]=void 0);t?n.props=s?i:gt(i):n.type.props?n.props=i:n.props=l,n.attrs=l}function n3(n,e,t,s){const{props:i,attrs:l,vnode:{patchFlag:r}}=n,o=V(i),[h]=n.propsOptions;let f=!1;if((s||r>0)&&!(r&16)){if(r&8){const d=n.vnode.dynamicProps;for(let p=0;p<d.length;p++){let w=d[p];if(a2(n.emitsOptions,w))continue;const T=e[w];if(h)if(K(l,w))T!==l[w]&&(l[w]=T,f=!0);else{const j=J1(w);i[j]=A2(h,o,j,T,n,!1)}else T!==l[w]&&(l[w]=T,f=!0)}}}else{ye(n,e,i,l)&&(f=!0);let d;for(const p in o)(!e||!K(e,p)&&((d=on(p))===p||!K(e,d)))&&(h?t&&(t[p]!==void 0||t[d]!==void 0)&&(i[p]=A2(h,o,p,void 0,n,!0)):delete i[p]);if(l!==o)for(const p in l)(!e||!K(e,p))&&(delete l[p],f=!0)}f&&B1(n.attrs,"set","")}function ye(n,e,t,s){const[i,l]=n.propsOptions;let r=!1,o;if(e)for(let h in e){if(Tn(h))continue;const f=e[h];let d;i&&K(i,d=J1(h))?!l||!l.includes(d)?t[d]=f:(o||(o={}))[d]=f:a2(n.emitsOptions,h)||(!(h in s)||f!==s[h])&&(s[h]=f,r=!0)}if(l){const h=V(t),f=o||z;for(let d=0;d<l.length;d++){const p=l[d];t[p]=A2(i,h,p,f[p],n,!K(f,p))}}return r}function A2(n,e,t,s,i,l){const r=n[t];if(r!=null){const o=K(r,"default");if(o&&s===void 0){const h=r.default;if(r.type!==Function&&!r.skipFactory&&F(h)){const{propsDefaults:f}=i;if(t in f)s=f[t];else{const d=Nn(i);s=f[t]=h.call(null,e),d()}}else s=h;i.ce&&i.ce._setProp(t,s)}r[0]&&(l&&!o?s=!1:r[1]&&(s===""||s===on(t))&&(s=!0))}return s}const e3=new WeakMap;function _e(n,e,t=!1){const s=t?e3:e.propsCache,i=s.get(n);if(i)return i;const l=n.props,r={},o=[];let h=!1;if(!F(n)){const d=p=>{h=!0;const[w,T]=_e(p,e,!0);s1(r,w),T&&o.push(...T)};!t&&e.mixins.length&&e.mixins.forEach(d),n.extends&&d(n.extends),n.mixins&&n.mixins.forEach(d)}if(!l&&!h)return X(n)&&s.set(n,dn),dn;if(M(l))for(let d=0;d<l.length;d++){const p=J1(l[d]);f0(p)&&(r[p]=z)}else if(l)for(const d in l){const p=J1(d);if(f0(p)){const w=l[d],T=r[p]=M(w)||F(w)?{type:w}:s1({},w),j=T.type;let H=!1,n1=!0;if(M(j))for(let k=0;k<j.length;++k){const I=j[k],Y=F(I)&&I.name;if(Y==="Boolean"){H=!0;break}else Y==="String"&&(n1=!1)}else H=F(j)&&j.name==="Boolean";T[0]=H,T[1]=n1,(H||K(T,"default"))&&o.push(p)}}const f=[r,o];return X(n)&&s.set(n,f),f}function f0(n){return n[0]!=="$"&&!Tn(n)}const be=n=>n[0]==="_"||n==="$stable",J2=n=>M(n)?n.map(F1):[F1(n)],t3=(n,e,t)=>{if(e._n)return e;const s=Rt((...i)=>J2(e(...i)),t);return s._c=!1,s},ve=(n,e,t)=>{const s=n._ctx;for(const i in n){if(be(i))continue;const l=n[i];if(F(l))e[i]=t3(i,l,s);else if(l!=null){const r=J2(l);e[i]=()=>r}}},xe=(n,e)=>{const t=J2(e);n.slots.default=()=>t},Se=(n,e,t)=>{for(const s in e)(t||s!=="_")&&(n[s]=e[s])},s3=(n,e,t)=>{const s=n.slots=me();if(n.vnode.shapeFlag&32){const i=e._;i?(Se(s,e,t),t&&L0(s,"_",i,!0)):ve(e,s)}else e&&xe(n,e)},i3=(n,e,t)=>{const{vnode:s,slots:i}=n;let l=!0,r=z;if(s.shapeFlag&32){const o=e._;o?t&&o===1?l=!1:Se(i,e,t):(l=!e.$stable,ve(e,i)),r=e}else e&&(xe(n,e),r={default:1});if(l)for(const o in i)!be(o)&&r[o]==null&&delete i[o]},y1=_3;function l3(n){return r3(n)}function r3(n,e){const t=s2();t.__VUE__=!0;const{insert:s,remove:i,patchProp:l,createElement:r,createText:o,createComment:h,setText:f,setElementText:d,parentNode:p,nextSibling:w,setScopeId:T=$1,insertStaticContent:j}=n,H=(a,c,u,y=null,m=null,g=null,x=void 0,v=null,b=!!c.dynamicChildren)=>{if(a===c)return;a&&!Sn(a,c)&&(y=Wn(a),R1(a,m,g,!0),a=null),c.patchFlag===-2&&(b=!1,c.dynamicChildren=null);const{type:_,ref:P,shapeFlag:S}=c;switch(_){case h2:n1(a,c,u,y);break;case rn:k(a,c,u,y);break;case kn:a==null&&I(c,u,y,x);break;case d1:$(a,c,u,y,m,g,x,v,b);break;default:S&1?Z(a,c,u,y,m,g,x,v,b):S&6?O(a,c,u,y,m,g,x,v,b):(S&64||S&128)&&_.process(a,c,u,y,m,g,x,v,b,_n)}P!=null&&m&&Xn(P,a&&a.ref,g,c||a,!c)},n1=(a,c,u,y)=>{if(a==null)s(c.el=o(c.children),u,y);else{const m=c.el=a.el;c.children!==a.children&&f(m,c.children)}},k=(a,c,u,y)=>{a==null?s(c.el=h(c.children||""),u,y):c.el=a.el},I=(a,c,u,y)=>{[a.el,a.anchor]=j(a.children,c,u,y,a.el,a.anchor)},Y=({el:a,anchor:c},u,y)=>{let m;for(;a&&a!==c;)m=w(a),s(a,u,y),a=m;s(c,u,y)},R=({el:a,anchor:c})=>{let u;for(;a&&a!==c;)u=w(a),i(a),a=u;i(c)},Z=(a,c,u,y,m,g,x,v,b)=>{c.type==="svg"?x="svg":c.type==="math"&&(x="mathml"),a==null?u1(c,u,y,m,g,x,v,b):P1(a,c,m,g,x,v,b)},u1=(a,c,u,y,m,g,x,v)=>{let b,_;const{props:P,shapeFlag:S,transition:E,dirs:A}=a;if(b=a.el=r(a.type,g,P&&P.is,P),S&8?d(b,a.children):S&16&&x1(a.children,b,null,y,m,_2(a,g),x,v),A&&nn(a,null,y,"created"),v1(b,a,a.scopeId,x,y),P){for(const G in P)G!=="value"&&!Tn(G)&&l(b,G,null,P[G],g,y);"value"in P&&l(b,"value",null,P.value,g),(_=P.onVnodeBeforeMount)&&D1(_,y,a)}A&&nn(a,null,y,"beforeMount");const N=o3(m,E);N&&E.beforeEnter(b),s(b,c,u),((_=P&&P.onVnodeMounted)||N||A)&&y1(()=>{_&&D1(_,y,a),N&&E.enter(b),A&&nn(a,null,y,"mounted")},m)},v1=(a,c,u,y,m)=>{if(u&&T(a,u),y)for(let g=0;g<y.length;g++)T(a,y[g]);if(m){let g=m.subTree;if(c===g||Pe(g.type)&&(g.ssContent===c||g.ssFallback===c)){const x=m.vnode;v1(a,x,x.scopeId,x.slotScopeIds,m.parent)}}},x1=(a,c,u,y,m,g,x,v,b=0)=>{for(let _=b;_<a.length;_++){const P=a[_]=v?q1(a[_]):F1(a[_]);H(null,P,c,u,y,m,g,x,v)}},P1=(a,c,u,y,m,g,x)=>{const v=c.el=a.el;let{patchFlag:b,dynamicChildren:_,dirs:P}=c;b|=a.patchFlag&16;const S=a.props||z,E=c.props||z;let A;if(u&&en(u,!1),(A=E.onVnodeBeforeUpdate)&&D1(A,u,c,a),P&&nn(c,a,u,"beforeUpdate"),u&&en(u,!0),(S.innerHTML&&E.innerHTML==null||S.textContent&&E.textContent==null)&&d(v,""),_?j1(a.dynamicChildren,_,v,u,y,_2(c,m),g):x||U(a,c,v,null,u,y,_2(c,m),g,!1),b>0){if(b&16)V1(v,S,E,u,m);else if(b&2&&S.class!==E.class&&l(v,"class",null,E.class,m),b&4&&l(v,"style",S.style,E.style,m),b&8){const N=c.dynamicProps;for(let G=0;G<N.length;G++){const q=N[G],p1=S[q],i1=E[q];(i1!==p1||q==="value")&&l(v,q,p1,i1,m,u)}}b&1&&a.children!==c.children&&d(v,c.children)}else!x&&_==null&&V1(v,S,E,u,m);((A=E.onVnodeUpdated)||P)&&y1(()=>{A&&D1(A,u,c,a),P&&nn(c,a,u,"updated")},y)},j1=(a,c,u,y,m,g,x)=>{for(let v=0;v<c.length;v++){const b=a[v],_=c[v],P=b.el&&(b.type===d1||!Sn(b,_)||b.shapeFlag&70)?p(b.el):u;H(b,_,P,null,y,m,g,x,!0)}},V1=(a,c,u,y,m)=>{if(c!==u){if(c!==z)for(const g in c)!Tn(g)&&!(g in u)&&l(a,g,c[g],null,m,y);for(const g in u){if(Tn(g))continue;const x=u[g],v=c[g];x!==v&&g!=="value"&&l(a,g,v,x,m,y)}"value"in u&&l(a,"value",c.value,u.value,m)}},$=(a,c,u,y,m,g,x,v,b)=>{const _=c.el=a?a.el:o(""),P=c.anchor=a?a.anchor:o("");let{patchFlag:S,dynamicChildren:E,slotScopeIds:A}=c;A&&(v=v?v.concat(A):A),a==null?(s(_,u,y),s(P,u,y),x1(c.children||[],u,P,m,g,x,v,b)):S>0&&S&64&&E&&a.dynamicChildren?(j1(a.dynamicChildren,E,u,m,g,x,v),(c.key!=null||m&&c===m.subTree)&&we(a,c,!0)):U(a,c,u,P,m,g,x,v,b)},O=(a,c,u,y,m,g,x,v,b)=>{c.slotScopeIds=v,a==null?c.shapeFlag&512?m.ctx.activate(c,u,y,x,b):C(c,u,y,m,g,x,b):D(a,c,b)},C=(a,c,u,y,m,g,x)=>{const v=a.component=E3(a,y,m);if(he(a)&&(v.ctx.renderer=_n),P3(v,!1,x),v.asyncDep){if(m&&m.registerDep(v,L,x),!a.el){const b=v.subTree=E1(rn);k(null,b,c,u)}}else L(v,a,c,u,m,g,x)},D=(a,c,u)=>{const y=c.component=a.component;if(g3(a,c,u))if(y.asyncDep&&!y.asyncResolved){W(y,c,u);return}else y.next=c,y.update();else c.el=a.el,y.vnode=c},L=(a,c,u,y,m,g,x)=>{const v=()=>{if(a.isMounted){let{next:S,bu:E,u:A,parent:N,vnode:G}=a;{const m1=Ce(a);if(m1){S&&(S.el=G.el,W(a,S,x)),m1.asyncDep.then(()=>{a.isUnmounted||v()});return}}let q=S,p1;en(a,!1),S?(S.el=G.el,W(a,S,x)):S=G,E&&f2(E),(p1=S.props&&S.props.onVnodeBeforeUpdate)&&D1(p1,N,S,G),en(a,!0);const i1=b2(a),T1=a.subTree;a.subTree=i1,H(T1,i1,p(T1.el),Wn(T1),a,m,g),S.el=i1.el,q===null&&y3(a,i1.el),A&&y1(A,m),(p1=S.props&&S.props.onVnodeUpdated)&&y1(()=>D1(p1,N,S,G),m)}else{let S;const{el:E,props:A}=c,{bm:N,m:G,parent:q,root:p1,type:i1}=a,T1=Pn(c);if(en(a,!1),N&&f2(N),!T1&&(S=A&&A.onVnodeBeforeMount)&&D1(S,q,c),en(a,!0),E&&e0){const m1=()=>{a.subTree=b2(a),e0(E,a.subTree,a,m,null)};T1&&i1.__asyncHydrate?i1.__asyncHydrate(E,a,m1):m1()}else{p1.ce&&p1.ce._injectChildStyle(i1);const m1=a.subTree=b2(a);H(null,m1,u,y,a,m,g),c.el=m1.el}if(G&&y1(G,m),!T1&&(S=A&&A.onVnodeMounted)){const m1=c;y1(()=>D1(S,q,m1),m)}(c.shapeFlag&256||q&&Pn(q.vnode)&&q.vnode.shapeFlag&256)&&a.a&&y1(a.a,m),a.isMounted=!0,c=u=y=null}};a.scope.on();const b=a.effect=new B0(v);a.scope.off();const _=a.update=b.run.bind(b),P=a.job=b.runIfDirty.bind(b);P.i=a,P.id=a.uid,b.scheduler=()=>k2(P),en(a,!0),_()},W=(a,c,u)=>{c.component=a;const y=a.vnode.props;a.vnode=c,a.next=null,n3(a,c.props,y,u),i3(a,c.children,u),X1(),o0(a),Z1()},U=(a,c,u,y,m,g,x,v,b=!1)=>{const _=a&&a.children,P=a?a.shapeFlag:0,S=c.children,{patchFlag:E,shapeFlag:A}=c;if(E>0){if(E&128){K1(_,S,u,y,m,g,x,v,b);return}else if(E&256){C1(_,S,u,y,m,g,x,v,b);return}}A&8?(P&16&&yn(_,m,g),S!==_&&d(u,S)):P&16?A&16?K1(_,S,u,y,m,g,x,v,b):yn(_,m,g,!0):(P&8&&d(u,""),A&16&&x1(S,u,y,m,g,x,v,b))},C1=(a,c,u,y,m,g,x,v,b)=>{a=a||dn,c=c||dn;const _=a.length,P=c.length,S=Math.min(_,P);let E;for(E=0;E<S;E++){const A=c[E]=b?q1(c[E]):F1(c[E]);H(a[E],A,u,null,m,g,x,v,b)}_>P?yn(a,m,g,!0,!1,S):x1(c,u,y,m,g,x,v,b,S)},K1=(a,c,u,y,m,g,x,v,b)=>{let _=0;const P=c.length;let S=a.length-1,E=P-1;for(;_<=S&&_<=E;){const A=a[_],N=c[_]=b?q1(c[_]):F1(c[_]);if(Sn(A,N))H(A,N,u,null,m,g,x,v,b);else break;_++}for(;_<=S&&_<=E;){const A=a[S],N=c[E]=b?q1(c[E]):F1(c[E]);if(Sn(A,N))H(A,N,u,null,m,g,x,v,b);else break;S--,E--}if(_>S){if(_<=E){const A=E+1,N=A<P?c[A].el:y;for(;_<=E;)H(null,c[_]=b?q1(c[_]):F1(c[_]),u,N,m,g,x,v,b),_++}}else if(_>E)for(;_<=S;)R1(a[_],m,g,!0),_++;else{const A=_,N=_,G=new Map;for(_=N;_<=E;_++){const g1=c[_]=b?q1(c[_]):F1(c[_]);g1.key!=null&&G.set(g1.key,_)}let q,p1=0;const i1=E-N+1;let T1=!1,m1=0;const bn=new Array(i1);for(_=0;_<i1;_++)bn[_]=0;for(_=A;_<=S;_++){const g1=a[_];if(p1>=i1){R1(g1,m,g,!0);continue}let A1;if(g1.key!=null)A1=G.get(g1.key);else for(q=N;q<=E;q++)if(bn[q-N]===0&&Sn(g1,c[q])){A1=q;break}A1===void 0?R1(g1,m,g,!0):(bn[A1-N]=_+1,A1>=m1?m1=A1:T1=!0,H(g1,c[A1],u,null,m,g,x,v,b),p1++)}const t0=T1?a3(bn):dn;for(q=t0.length-1,_=i1-1;_>=0;_--){const g1=N+_,A1=c[g1],s0=g1+1<P?c[g1+1].el:y;bn[_]===0?H(null,A1,u,s0,m,g,x,v,b):T1&&(q<0||_!==t0[q]?Q1(A1,u,s0,2):q--)}}},Q1=(a,c,u,y,m=null)=>{const{el:g,type:x,transition:v,children:b,shapeFlag:_}=a;if(_&6){Q1(a.component.subTree,c,u,y);return}if(_&128){a.suspense.move(c,u,y);return}if(_&64){x.move(a,c,u,_n);return}if(x===d1){s(g,c,u);for(let S=0;S<b.length;S++)Q1(b[S],c,u,y);s(a.anchor,c,u);return}if(x===kn){Y(a,c,u);return}if(y!==2&&_&1&&v)if(y===0)v.beforeEnter(g),s(g,c,u),y1(()=>v.enter(g),m);else{const{leave:S,delayLeave:E,afterLeave:A}=v,N=()=>s(g,c,u),G=()=>{S(g,()=>{N(),A&&A()})};E?E(g,N,G):G()}else s(g,c,u)},R1=(a,c,u,y=!1,m=!1)=>{const{type:g,props:x,ref:v,children:b,dynamicChildren:_,shapeFlag:P,patchFlag:S,dirs:E,cacheIndex:A}=a;if(S===-2&&(m=!1),v!=null&&Xn(v,null,u,a,!0),A!=null&&(c.renderCache[A]=void 0),P&256){c.ctx.deactivate(a);return}const N=P&1&&E,G=!Pn(a);let q;if(G&&(q=x&&x.onVnodeBeforeUnmount)&&D1(q,c,a),P&6)Le(a.component,u,y);else{if(P&128){a.suspense.unmount(u,y);return}N&&nn(a,null,c,"beforeUnmount"),P&64?a.type.remove(a,c,u,_n,y):_&&!_.hasOnce&&(g!==d1||S>0&&S&64)?yn(_,c,u,!1,!0):(g===d1&&S&384||!m&&P&16)&&yn(b,c,u),y&&Z2(a)}(G&&(q=x&&x.onVnodeUnmounted)||N)&&y1(()=>{q&&D1(q,c,a),N&&nn(a,null,c,"unmounted")},u)},Z2=a=>{const{type:c,el:u,anchor:y,transition:m}=a;if(c===d1){$e(u,y);return}if(c===kn){R(a);return}const g=()=>{i(u),m&&!m.persisted&&m.afterLeave&&m.afterLeave()};if(a.shapeFlag&1&&m&&!m.persisted){const{leave:x,delayLeave:v}=m,b=()=>x(u,g);v?v(a.el,g,b):b()}else g()},$e=(a,c)=>{let u;for(;a!==c;)u=w(a),i(a),a=u;i(c)},Le=(a,c,u)=>{const{bum:y,scope:m,job:g,subTree:x,um:v,m:b,a:_}=a;u0(b),u0(_),y&&f2(y),m.stop(),g&&(g.flags|=8,R1(x,a,c,u)),v&&y1(v,c),y1(()=>{a.isUnmounted=!0},c),c&&c.pendingBranch&&!c.isUnmounted&&a.asyncDep&&!a.asyncResolved&&a.suspenseId===c.pendingId&&(c.deps--,c.deps===0&&c.resolve())},yn=(a,c,u,y=!1,m=!1,g=0)=>{for(let x=g;x<a.length;x++)R1(a[x],c,u,y,m)},Wn=a=>{if(a.shapeFlag&6)return Wn(a.component.subTree);if(a.shapeFlag&128)return a.suspense.next();const c=w(a.anchor||a.el),u=c&&c[At];return u?w(u):c};let c2=!1;const Q2=(a,c,u)=>{a==null?c._vnode&&R1(c._vnode,null,null,!0):H(c._vnode||null,a,c,null,null,null,u),c._vnode=a,c2||(c2=!0,o0(),le(),c2=!1)},_n={p:H,um:R1,m:Q1,r:Z2,mt:C,mc:x1,pc:U,pbc:j1,n:Wn,o:n};let n0,e0;return{render:Q2,hydrate:n0,createApp:Xt(Q2,n0)}}function _2({type:n,props:e},t){return t==="svg"&&n==="foreignObject"||t==="mathml"&&n==="annotation-xml"&&e&&e.encoding&&e.encoding.includes("html")?void 0:t}function en({effect:n,job:e},t){t?(n.flags|=32,e.flags|=4):(n.flags&=-33,e.flags&=-5)}function o3(n,e){return(!n||n&&!n.pendingBranch)&&e&&!e.persisted}function we(n,e,t=!1){const s=n.children,i=e.children;if(M(s)&&M(i))for(let l=0;l<s.length;l++){const r=s[l];let o=i[l];o.shapeFlag&1&&!o.dynamicChildren&&((o.patchFlag<=0||o.patchFlag===32)&&(o=i[l]=q1(i[l]),o.el=r.el),!t&&o.patchFlag!==-2&&we(r,o)),o.type===h2&&(o.el=r.el)}}function a3(n){const e=n.slice(),t=[0];let s,i,l,r,o;const h=n.length;for(s=0;s<h;s++){const f=n[s];if(f!==0){if(i=t[t.length-1],n[i]<f){e[s]=i,t.push(s);continue}for(l=0,r=t.length-1;l<r;)o=l+r>>1,n[t[o]]<f?l=o+1:r=o;f<n[t[l]]&&(l>0&&(e[s]=t[l-1]),t[l]=s)}}for(l=t.length,r=t[l-1];l-- >0;)t[l]=r,r=e[r];return t}function Ce(n){const e=n.subTree.component;if(e)return e.asyncDep&&!e.asyncResolved?e:Ce(e)}function u0(n){if(n)for(let e=0;e<n.length;e++)n[e].flags|=8}const h3=Symbol.for("v-scx"),c3=()=>Kn(h3);function An(n,e,t){return Te(n,e,t)}function Te(n,e,t=z){const{immediate:s,deep:i,flush:l,once:r}=t,o=s1({},t),h=e&&s||!e&&l!=="post";let f;if(Ln){if(l==="sync"){const T=c3();f=T.__watcherHandles||(T.__watcherHandles=[])}else if(!h){const T=()=>{};return T.stop=$1,T.resume=$1,T.pause=$1,T}}const d=f1;o.call=(T,j,H)=>L1(T,d,j,H);let p=!1;l==="post"?o.scheduler=T=>{y1(T,d&&d.suspense)}:l!=="sync"&&(p=!0,o.scheduler=(T,j)=>{j?T():k2(T)}),o.augmentJob=T=>{e&&(T.flags|=4),p&&(T.flags|=2,d&&(T.id=d.uid,T.i=d))};const w=Ct(n,e,o);return Ln&&(f?f.push(w):h&&w()),w}function d3(n,e,t){const s=this.proxy,i=Q(n)?n.includes(".")?Oe(s,n):()=>s[n]:n.bind(s,s);let l;F(e)?l=e:(l=e.handler,t=e);const r=Nn(this),o=Te(i,l.bind(s),t);return r(),o}function Oe(n,e){const t=e.split(".");return()=>{let s=n;for(let i=0;i<t.length&&s;i++)s=s[t[i]];return s}}const f3=(n,e)=>e==="modelValue"||e==="model-value"?n.modelModifiers:n[`${e}Modifiers`]||n[`${J1(e)}Modifiers`]||n[`${on(e)}Modifiers`];function u3(n,e,...t){if(n.isUnmounted)return;const s=n.vnode.props||z;let i=t;const l=e.startsWith("update:"),r=l&&f3(s,e.slice(7));r&&(r.trim&&(i=t.map(d=>Q(d)?d.trim():d)),r.number&&(i=t.map(Ve)));let o,h=s[o=d2(e)]||s[o=d2(J1(e))];!h&&l&&(h=s[o=d2(on(e))]),h&&L1(h,n,6,i);const f=s[o+"Once"];if(f){if(!n.emitted)n.emitted={};else if(n.emitted[o])return;n.emitted[o]=!0,L1(f,n,6,i)}}function Ee(n,e,t=!1){const s=e.emitsCache,i=s.get(n);if(i!==void 0)return i;const l=n.emits;let r={},o=!1;if(!F(n)){const h=f=>{const d=Ee(f,e,!0);d&&(o=!0,s1(r,d))};!t&&e.mixins.length&&e.mixins.forEach(h),n.extends&&h(n.extends),n.mixins&&n.mixins.forEach(h)}return!l&&!o?(X(n)&&s.set(n,null),null):(M(l)?l.forEach(h=>r[h]=null):s1(r,l),X(n)&&s.set(n,r),r)}function a2(n,e){return!n||!n2(e)?!1:(e=e.slice(2).replace(/Once$/,""),K(n,e[0].toLowerCase()+e.slice(1))||K(n,on(e))||K(n,e))}function b2(n){const{type:e,vnode:t,proxy:s,withProxy:i,propsOptions:[l],slots:r,attrs:o,emit:h,render:f,renderCache:d,props:p,data:w,setupState:T,ctx:j,inheritAttrs:H}=n,n1=zn(n);let k,I;try{if(t.shapeFlag&4){const R=i||s,Z=R;k=F1(f.call(Z,R,d,p,T,w,j)),I=o}else{const R=e;k=F1(R.length>1?R(p,{attrs:o,slots:r,emit:h}):R(p,null)),I=e.props?o:p3(o)}}catch(R){Dn.length=0,r2(R,n,1),k=E1(rn)}let Y=k;if(I&&H!==!1){const R=Object.keys(I),{shapeFlag:Z}=Y;R.length&&Z&7&&(l&&R.some(H2)&&(I=m3(I,l)),Y=gn(Y,I,!1,!0))}return t.dirs&&(Y=gn(Y,null,!1,!0),Y.dirs=Y.dirs?Y.dirs.concat(t.dirs):t.dirs),t.transition&&q2(Y,t.transition),k=Y,zn(n1),k}const p3=n=>{let e;for(const t in n)(t==="class"||t==="style"||n2(t))&&((e||(e={}))[t]=n[t]);return e},m3=(n,e)=>{const t={};for(const s in n)(!H2(s)||!(s.slice(9)in e))&&(t[s]=n[s]);return t};function g3(n,e,t){const{props:s,children:i,component:l}=n,{props:r,children:o,patchFlag:h}=e,f=l.emitsOptions;if(e.dirs||e.transition)return!0;if(t&&h>=0){if(h&1024)return!0;if(h&16)return s?p0(s,r,f):!!r;if(h&8){const d=e.dynamicProps;for(let p=0;p<d.length;p++){const w=d[p];if(r[w]!==s[w]&&!a2(f,w))return!0}}}else return(i||o)&&(!o||!o.$stable)?!0:s===r?!1:s?r?p0(s,r,f):!0:!!r;return!1}function p0(n,e,t){const s=Object.keys(e);if(s.length!==Object.keys(n).length)return!0;for(let i=0;i<s.length;i++){const l=s[i];if(e[l]!==n[l]&&!a2(t,l))return!0}return!1}function y3({vnode:n,parent:e},t){for(;e;){const s=e.subTree;if(s.suspense&&s.suspense.activeBranch===n&&(s.el=n.el),s===n)(n=e.vnode).el=t,e=e.parent;else break}}const Pe=n=>n.__isSuspense;function _3(n,e){e&&e.pendingBranch?M(n)?e.effects.push(...n):e.effects.push(n):Pt(n)}const d1=Symbol.for("v-fgt"),h2=Symbol.for("v-txt"),rn=Symbol.for("v-cmt"),kn=Symbol.for("v-stc"),Dn=[];let b1=null;function l1(n=!1){Dn.push(b1=n?null:[])}function b3(){Dn.pop(),b1=Dn[Dn.length-1]||null}let $n=1;function m0(n,e=!1){$n+=n,n<0&&b1&&e&&(b1.hasOnce=!0)}function Re(n){return n.dynamicChildren=$n>0?b1||dn:null,b3(),$n>0&&b1&&b1.push(n),n}function h1(n,e,t,s,i,l){return Re(B(n,e,t,s,i,l,!0))}function v3(n,e,t,s,i){return Re(E1(n,e,t,s,i,!0))}function Ae(n){return n?n.__v_isVNode===!0:!1}function Sn(n,e){return n.type===e.type&&n.key===e.key}const De=({key:n})=>n??null,qn=({ref:n,ref_key:e,ref_for:t})=>(typeof n=="number"&&(n=""+n),n!=null?Q(n)||t1(n)||F(n)?{i:H1,r:n,k:e,f:!!t}:n:null);function B(n,e=null,t=null,s=0,i=null,l=n===d1?0:1,r=!1,o=!1){const h={__v_isVNode:!0,__v_skip:!0,type:n,props:e,key:e&&De(e),ref:e&&qn(e),scopeId:oe,slotScopeIds:null,children:t,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:l,patchFlag:s,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:H1};return o?(z2(h,t),l&128&&n.normalize(h)):t&&(h.shapeFlag|=Q(t)?8:16),$n>0&&!r&&b1&&(h.patchFlag>0||l&6)&&h.patchFlag!==32&&b1.push(h),h}const E1=x3;function x3(n,e=null,t=null,s=0,i=null,l=!1){if((!n||n===Vt)&&(n=rn),Ae(n)){const o=gn(n,e,!0);return t&&z2(o,t),$n>0&&!l&&b1&&(o.shapeFlag&6?b1[b1.indexOf(n)]=o:b1.push(o)),o.patchFlag=-2,o}if(M3(n)&&(n=n.__vccOpts),e){e=S3(e);let{class:o,style:h}=e;o&&!Q(o)&&(e.class=I1(o)),X(h)&&(K2(h)&&!M(h)&&(h=s1({},h)),e.style=i2(h))}const r=Q(n)?1:Pe(n)?128:Dt(n)?64:X(n)?4:F(n)?2:0;return B(n,e,t,s,i,r,l,!0)}function S3(n){return n?K2(n)||ge(n)?s1({},n):n:null}function gn(n,e,t=!1,s=!1){const{props:i,ref:l,patchFlag:r,children:o,transition:h}=n,f=e?C3(i||{},e):i,d={__v_isVNode:!0,__v_skip:!0,type:n.type,props:f,key:f&&De(f),ref:e&&e.ref?t&&l?M(l)?l.concat(qn(e)):[l,qn(e)]:qn(e):l,scopeId:n.scopeId,slotScopeIds:n.slotScopeIds,children:o,target:n.target,targetStart:n.targetStart,targetAnchor:n.targetAnchor,staticCount:n.staticCount,shapeFlag:n.shapeFlag,patchFlag:e&&n.type!==d1?r===-1?16:r|16:r,dynamicProps:n.dynamicProps,dynamicChildren:n.dynamicChildren,appContext:n.appContext,dirs:n.dirs,transition:h,component:n.component,suspense:n.suspense,ssContent:n.ssContent&&gn(n.ssContent),ssFallback:n.ssFallback&&gn(n.ssFallback),el:n.el,anchor:n.anchor,ctx:n.ctx,ce:n.ce};return h&&s&&q2(d,h.clone(d)),d}function Me(n=" ",e=0){return E1(h2,null,n,e)}function w3(n,e){const t=E1(kn,null,n);return t.staticCount=e,t}function wn(n="",e=!1){return e?(l1(),v3(rn,null,n)):E1(rn,null,n)}function F1(n){return n==null||typeof n=="boolean"?E1(rn):M(n)?E1(d1,null,n.slice()):Ae(n)?q1(n):E1(h2,null,String(n))}function q1(n){return n.el===null&&n.patchFlag!==-1||n.memo?n:gn(n)}function z2(n,e){let t=0;const{shapeFlag:s}=n;if(e==null)e=null;else if(M(e))t=16;else if(typeof e=="object")if(s&65){const i=e.default;i&&(i._c&&(i._d=!1),z2(n,i()),i._c&&(i._d=!0));return}else{t=32;const i=e._;!i&&!ge(e)?e._ctx=H1:i===3&&H1&&(H1.slots._===1?e._=1:(e._=2,n.patchFlag|=1024))}else F(e)?(e={default:e,_ctx:H1},t=32):(e=String(e),s&64?(t=16,e=[Me(e)]):t=8);n.children=e,n.shapeFlag|=t}function C3(...n){const e={};for(let t=0;t<n.length;t++){const s=n[t];for(const i in s)if(i==="class")e.class!==s.class&&(e.class=I1([e.class,s.class]));else if(i==="style")e.style=i2([e.style,s.style]);else if(n2(i)){const l=e[i],r=s[i];r&&l!==r&&!(M(l)&&l.includes(r))&&(e[i]=l?[].concat(l,r):r)}else i!==""&&(e[i]=s[i])}return e}function D1(n,e,t,s=null){L1(n,e,7,[t,s])}const T3=ue();let O3=0;function E3(n,e,t){const s=n.type,i=(e?e.appContext:n.appContext)||T3,l={uid:O3++,vnode:n,type:s,parent:e,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new ze(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:e?e.provides:Object.create(i.provides),ids:e?e.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:_e(s,i),emitsOptions:Ee(s,i),emit:null,emitted:null,propsDefaults:z,inheritAttrs:s.inheritAttrs,ctx:z,data:z,props:z,attrs:z,slots:z,refs:z,setupState:z,setupContext:null,suspense:t,suspenseId:t?t.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return l.ctx={_:l},l.root=e?e.root:l,l.emit=u3.bind(null,l),n.ce&&n.ce(l),l}let f1=null,Qn,D2;{const n=s2(),e=(t,s)=>{let i;return(i=n[t])||(i=n[t]=[]),i.push(s),l=>{i.length>1?i.forEach(r=>r(l)):i[0](l)}};Qn=e("__VUE_INSTANCE_SETTERS__",t=>f1=t),D2=e("__VUE_SSR_SETTERS__",t=>Ln=t)}const Nn=n=>{const e=f1;return Qn(n),n.scope.on(),()=>{n.scope.off(),Qn(e)}},g0=()=>{f1&&f1.scope.off(),Qn(null)};function Ie(n){return n.vnode.shapeFlag&4}let Ln=!1;function P3(n,e=!1,t=!1){e&&D2(e);const{props:s,children:i}=n.vnode,l=Ie(n);Qt(n,s,l,e),s3(n,i,t);const r=l?R3(n,e):void 0;return e&&D2(!1),r}function R3(n,e){const t=n.type;n.accessCache=Object.create(null),n.proxy=new Proxy(n.ctx,Kt);const{setup:s}=t;if(s){X1();const i=n.setupContext=s.length>1?D3(n):null,l=Nn(n),r=jn(s,n,0,[n.props,i]),o=I0(r);if(Z1(),l(),(o||n.sp)&&!Pn(n)&&ae(n),o){if(r.then(g0,g0),e)return r.then(h=>{y0(n,h,e)}).catch(h=>{r2(h,n,0)});n.asyncDep=r}else y0(n,r,e)}else Fe(n,e)}function y0(n,e,t){F(e)?n.type.__ssrInlineRender?n.ssrRender=e:n.render=e:X(e)&&(n.setupState=te(e)),Fe(n,t)}let _0;function Fe(n,e,t){const s=n.type;if(!n.render){if(!e&&_0&&!s.render){const i=s.template||G2(n).template;if(i){const{isCustomElement:l,compilerOptions:r}=n.appContext.config,{delimiters:o,compilerOptions:h}=s,f=s1(s1({isCustomElement:l,delimiters:o},r),h);s.render=_0(i,f)}}n.render=s.render||$1}{const i=Nn(n);X1();try{kt(n)}finally{Z1(),i()}}}const A3={get(n,e){return r1(n,"get",""),n[e]}};function D3(n){const e=t=>{n.exposed=t||{}};return{attrs:new Proxy(n.attrs,A3),slots:n.slots,emit:n.emit,expose:e}}function X2(n){return n.exposed?n.exposeProxy||(n.exposeProxy=new Proxy(te(yt(n.exposed)),{get(e,t){if(t in e)return e[t];if(t in Rn)return Rn[t](n)},has(e,t){return t in e||t in Rn}})):n.proxy}function M3(n){return F(n)&&"__vccOpts"in n}const I3=(n,e)=>St(n,e,Ln),F3="3.5.13";/**
...
小孩1点半和2点和2点半叫过，我在补发作记录，明天看病`,hh:[16],s4:4},"2026-03-27":{coner:["华山/朱"],detail:`没麻，6.18，1.08到7.35，打断5，10
10:28到现在没有，在诊室门口
11:45左手左脚烫，起来后没有过梦境
14:01说没有过梦境，今天西院也没药
15.30 梦境，重，橡胶
21:14和小婷玩好回来有2，3次重的，30秒大概
22:48询问，有过5分，30秒，在干活
23:17不舒服，洗好澡在涂香香，和上次差不多`,hh:[15,21,22,23],s3:1,s4:0},"2026-03-28":{detail:`睡前眼睛跳，鬼压床，6.29，1.46到8.35
12:21拒绝回答
15:33睡了会，问，又说不知道
18:17说忘记了，让仔细想，说没重的今天`,hh:[],s3:0,s4:0},"2026-03-29":{detail:`没麻，7.20，10.5到8.39，打断7，14
11:06应该没有
17:13有过2次中等的，5，6分，半分钟
19.49 梦境，熟悉，橡胶，重，8分的，60秒
23:15可能有过一次中等的`,hh:[17,19,23],s3:0,s4:3},"2026-03-30":{detail:`没麻，睡得也不好，前几天也是，小哈咳嗽，840我叫起来的，没带手表
11:07看到小哈鸡鸡有4，5分的，10秒，起来到现在可能没有
14:15没有过，在地铁上，去儿童医院
15:32没事，但是一直有点晕
16:37有过一般般的，想不起来了，准备从医院回家
18:13 有过，在地铁上
19.24 梦境，重，7分，想吐
20:17不舒服，30秒，在吃饺子`,hh:[11,16,18,19,20],s3:0,s4:4},"2026-03-31":{detail:`没麻，6.39，0.53到8.08，打断多
13:01不舒服，进房间坐了，重，不回答，半分钟，7，8分
14:49不舒服，刚吃好饭不久，打嗝2次，6，7分，40秒
17.40 重，拉屎，吐，8分，橡胶
18.49 梦境，吐，拉屎，橡胶，7分
19:32不舒服，一样的，7，8分
21.16 梦境, 吐, 橡胶, 8分, 熟悉, 17, 重, 10分`,hh:[13,14,17,18,19,21],s3:0,s4:4},"2026-04-01":{detail:`没麻，早上小哈不肯上学，打了妈妈脸，然后他状态也不好，没记录
8.53 梦境5分橡胶
10:254分，然后睡觉了
13:035分不舒服
14:56左手烫
15:15不舒服，重的，7，8分，30秒
19:48不舒服，5分，20到30秒`,hh:[8,13,15,19],s3:0,s4:3},"2026-04-02":{detail:`没麻，8.24，22.49到7.40
17.45 梦境，7，8分，一段时间前也有一次
18:48不舒服，1分钟，9分，有橡胶
21:06不舒服，在准备吹头发，9，10分，多久不知道，说30，我说不止，说"就1分钟吧"，然后很久的时间都打嗝多，洗澡的时候也可能有`,hh:[17,18,21],s3:0,s4:2},"2026-04-03":{detail:`没麻，7.09，23.54到8.00
8.59 橡胶梦境8分
12:31打嗝一直多
14:23不舒服，在拒绝圈圈马肖约会，7，8分
16.14 梦境，自己记的其他都没记
17:26不舒服，跑到房间里来，8分，今天打嗝比较多
18:20不舒服，40秒，8，9分，然后还一直打嗝
18:51 不舒服，1分钟多，8，9分，重的，吃虾停下来了
20:16不舒服，在听马肖说找工作，20秒，自己觉得半分钟，7，8分
23:16不舒服，8，9分，30秒
00:22算有2秒`,hh:[8,14,16,17,18,20,23],s3:1,s4:6},"2026-04-04":{detail:`可能没有，0.33到8.05
09:08不舒服，正在问昨晚的情况，自己说50秒，8分，发完左手烫，前后还一直打嗝，然后干活了，文帝的
11.16 梦境，3分，吐，太阳穴
16.58 橡胶8分20秒
19:25不舒服，在吃饭，筷子放下了，10分，1分钟
21:36洗好澡，洗澡的时候有10分，1分钟`,hh:[9,11,16,19,21],s3:0,s4:3},"2026-04-05":{detail:`没麻，5.56，0.55到8.16，打断9，1.25，2点半和5点半醒半小时
13:12上午睡了会，打嗝多
然后我睡到了下午4点，他还是打嗝很多
一天没吃饭，我8点多吃饭问他，一直说不吃想吐，逼吃后状态好一些，之前不爱说话，成天拿着电脑弄林博士，前一天还在看知乎心理啥的，看得出这两天心情不好
晚上看手机记录：
10.28 手烫
11.32 梦境，10分，1分钟
11.42 9分，1分钟
...
18.13 梦境2次
18.40 梦境
19.04 梦境，重，鸡皮疙瘩，8分，熟悉
19.56 梦境
20.11 梦境，重，8分
23.21 梦境，8分
0.45 坐起来，问怎么了，说说不清，然后眼睛跳了，半分钟吧好了`,hh:[11,15,17,18,19,20,23],s3:1,s4:2},"2026-04-06":{detail:`前一天记录是睡前眼睛跳的，6.14，0.38到8.09，打断9，1.17，5点到5.41醒着
早上问有没有不舒服，追问也说忘记
后来追问上午忘记了，说不是都记的，所以推测有
12.58 梦境8分1分钟
下午睡觉，我和小哈出去抓蝌蚪，睡前有很重8，9分，醒来鬼压床
16.01 梦境，重，拉屎
18.18 梦境
18:31不舒服，主动进房间，打嗝很多，2分钟问才说好，问程度和时间不说，35说刚才是和梦里一模一样，才有橡胶的
23:07不确定有没有重的，对上次和小孩去罗南开摩托车印象不深了，问是不是心情也不好，这两天，说是的，聊了下最近一个月的事，和前进吃饭，小哈看病，圈圈吃饭，去奉贤，记性都比较差`,hh:[12,16,18],s3:0,s4:1},"2026-04-07":{detail:`没麻
13:14早上去罗南老马都了圈，不一定有重的
18:36下午有一次或者2次重的熟悉
21:18重的应该没有
21:29准备洗澡看蝌蚪的时候有一点，不太明显的，但是确定是有的`,hh:[18,21],s3:0,s4:2},"2026-04-08":{detail:`没麻，但是早上一直打嗝
13:18上午没重的
16:05 梦境，重，熟悉，然后打嗝多，还说不是每次都记的，在干活，拒绝回答
19.18 梦境，5分，熟悉
20.30 梦境，重，熟悉，80秒，第二天早上问几分钟，说肯定很重才这么记，又说8分
2240睡，2308动了下，不知道是不是不舒服，没睁眼，但是手往左边摸了下`,hh:[16,19,20],s3:0,s4:1},"2026-04-09":{detail:`没麻，到834还是没重，但打嗝多，口腔溃疡可能已经一周多了，还在慢慢变多
18.44 我在洗鱼，6，7分，10秒和20秒，算一起，30秒吧
20:10不舒服，在吃饭，8，9分，1分钟
22:20不舒服，半分钟，5分，打嗝还是多`,hh:[18,20,22],s3:0,s4:3},"2026-04-10":{detail:`没麻
08:48不舒服，重，肚子叫，今天早上就一直打嗝，1分钟，7，8分
16:29我和奶奶从远香湖回来，大概率没重的，但是打嗝多
19:59不舒服，问多久几分，说日常，是6，7分，30秒，每天超过10次，不知道有没有15次
21:56在厕所1小时，我看了，靠着门拿手机刷视频, 22.19洗好回来, 问情况, 1次不是很重`,hh:[8,19,21],s3:0,s4:4},"2026-04-11":{detail:`没麻
12:58应该没重，但是打嗝还是有
19:15 梦境，10分，重，50秒`,hh:[19],s3:0,s4:1},"2026-04-12":{detail:`不麻
11:24没重，问有没有过，忘记了
22:53应该没有
23:15打嗝很多，就最近开始的。今天大扫除`,hh:[],s3:1,s4:0},"2026-04-13":{detail:`起床有鬼压床
打嗝还是有
13:49没有，但是打嗝
21:51没有重的，今天下午说最近明显少`,hh:[],s3:0,s4:0},"2026-04-14":{detail:`没麻
22:15没重的，有过2，3次中等的，打嗝还是多
00:37打嗝很多，非常多，说没重的，有小的，在搞林博士，我和小哈早睡了`,hh:[],s3:1,s4:0},"2026-04-15":{detail:`没麻，不确定，可能半夜麻，睡觉显示1.27到6.10，持续2.15，可能是没切换睡觉模式，但肯定也是睡得不好的，和可能觉得半夜麻对应了
7.22 在厕所，重，肚子开始疼
14:18没有重的，可能没有，在七号冰室吃饭，带回去coco，再兜一圈接小哈
14:42半分钟的，7，8分，在买coco
18:54没有重的`,hh:[7,14],s3:0,s4:2},"2026-04-16":{detail:`不麻
08:55在吃早饭，说包子蒸屉的味道难闻，我认为没有味道
15:05没有重的不舒服，肚子疼，2分，但是很担心
17:56梦境，半分钟，6，7分
18:47不舒服，很重，2分钟多，9分，熟悉想吐，梦境，橡胶
18:51又有了，刚发完2分钟，51末开始，刚才50头结束，1分钟多，7分
20:22 我进房间，发作过，说搞不清楚情况了，刚吃过饭，25分说，40秒左右觉得块好了，然后又闻到味道，记得吃饭，记得周四，说9分重的，没断片感
20:57今天下午开始说太阳穴紧，两边，现在是左边紧
23:03左边太阳穴紧
23:05又在聊安乐死和死后外婆之类的，自己说心情没问题
23:21打嗝，没不舒服`,hh:[17,18,20,23],s3:0,s4:4},"2026-04-17":{coner:["总院","总院配药, 10盒开浦兰"],detail:`没麻，和前天一样的显示形式，用时间2.55，打断13，4.21，说晚上肚子疼，前一天加中午的睡觉9.38
10:54没重的，在总院配药排队
14:11问有没有4分疼，点头，没敢问有没有不舒服，回家的地铁站里
15:11到家，问了，没重的
17:19肚子疼，睡了大概，10分钟，醒的时候小发，咽口水，眼睛跳
19:36觉得青菜的味道难闻，肉汤难闻`,hh:[],s3:1,s4:0},"2026-04-18":{detail:`没麻
14:34没有重的
21:17打嗝又多了，但是问，结果是肚子疼`,hh:[],s3:0,s4:0},"2026-04-19":{detail:`没麻
1056有打嗝，没重
20:14应该没有重的，在天街买生煎
20:54左半边脸麻麻的，下巴也有一点，没有别的不舒服，05脸好了，手烫，说之前也有，然后开始打嗝变多
22:27洗好澡有不舒服，轻的，具体忘记了`,hh:[],s3:0,s4:1},"2026-04-20":{detail:`可能没
09:27打嗝多
15:40没有重的，确认了最近都还可以，但是打嗝多
19:48半分钟，不舒服，我进房间站着拿着饼干不动，熟悉梦境
19:53手和脚烫麻
21:01不舒服，左边下巴麻，30秒说就麻，问有没有梦境，说忘记了，04还没好`,hh:[19,21],s3:0,s4:3},"2026-04-21":{detail:`没麻，但是620醒的，831问有没有不舒服，说不知道，那我感觉是有的，问有重吗，回没
13:12打嗝，我情绪差，在图书馆要回家尿尿，吃饭又不肯吃，打嗝
下午2点睡到5.30
18:41睡前麻，现在打嗝多
21:45不舒服，问重不重，说讲不清楚
22:28打嗝多，我感觉状态不正常问情况，说不知道，感觉心情不好，硬要带着耳机在外面弄电脑`,hh:[],s3:1,s4:0},"2026-04-22":{detail:`没麻
14:18回家后我洗洗地机，洗好看他趴在衣柜上面什么也不做
14:28说好出去吃饭一会又不肯去了，说自己吃饼干，我就在家吃了，问有没有梦境说没有，全程手机都没拿，躺下睡觉了，这两天天天去图书馆，我心情不好对他态度不好
19.19 自己记录重的梦境`,hh:[19],s3:0,s4:0},"2026-04-23":{detail:`没麻
11:10手涨，补充说经常这样子的，今天没打嗝
12:59在馄饨店门口，因为吃饭的问题，仔细考虑，暂时打算今天开始不催吃饭，不问发作，对卢广仲又表现得很兴奋，让我觉得很不舒服
13:30打嗝变多
19:36一天没吃饭，在家看手机，我问吃不吃生煎帮带，他不回，后来回了，不要吃
19:50打电话问奶茶要不要，口气比较坏和低地拒绝
20:19这两天都说冷`,hh:[],s3:0,s4:0},"2026-04-24":{coner:["妇婴+哈住院","一妇婴+哈住院"],detail:`没有
11:08左脚走路麻，左手烫，在从一妇婴去儿童医院的路上
15.59 自己记录 重，梦境橡胶
16:49我在医院里，他在一妇婴，刚碰头，有过重的，说自己记过了
18:36梦境熟悉橡胶，刚洗完澡，8，9分，1分钟`,hh:[15,16,18],s3:0,s4:1},"2026-04-25":{detail:`没麻，昨晚陪夜，护士硬开灯给小哈带氧气叫醒的，睡着过
8.49 重，自己记的
10:02医生查房，查房前说远处有重影，现在好了
10:40左脚麻，溜出来去精品兜一下，然后姐打算来送点书
13:08梦境非常重，非常难过，熟悉，橡胶也很重，觉得有11分，一下子好的，30秒
14:27不舒服，重，8分，30秒
17:08不舒服，6分，20秒
17:35不舒服，10分，30秒
19:39不舒服，40秒，78分，有味道
21:07和外婆往上吵架，左边脸麻，14还没好
21:30和外婆打电话，进来了一下，出去的时候打嗝2次`,hh:[8,13,14,17,19,21],s3:1,s4:5},"2026-04-26":{detail:`晚上麻过
11:00不舒服，20秒，5，6分
19.52 重，自己手机记的
20:58熟悉，梦境，一模一样，10分，1分钟不到一点`,hh:[11,19,20],s3:0,s4:1},"2026-04-27":{detail:`应该没，今天没睡一起
16:18问情况，说不是都记的，这两天感觉有发烧，背疼之类的，细问，到医院后有重的吗，说应该有，3次
16:37去医院的路上说，前2天睡觉都觉得喉咙疼的
18:11看完病，到新闸路的太荒鸡吃饭，熟悉梦境，没有觉得难过，是真假难辨，真的觉得梦到过`,hh:[16,18],s3:0,s4:2},"2026-04-28":{detail:`睡到闹钟醒，按了几次，我830打视频的，看起来还可以，问麻没麻说不知道
15,23 自己记重
19.11 自己记重
20.56 自己记重
从罗南回来路上有，今天是5，6`,hh:[15,19,20],s3:0,s4:0},"2026-04-29":{detail:`没麻
09.18 梦境
14.00 中等
15.16 梦境6分
18:346分的，30秒，在吃饭，我睡了一天
20.10 梦境，8分
01:16刚上床10分钟，还没睡着, 今天在看林博士的网站优化, 很兴奋
02:08打嗝，说了半句胡话，从摄像头看正常`,hh:[9,15,18,20],s3:1,s4:1},"2026-04-30":{memo:"抑郁",detail:`说不知道有没有麻
10:21出门找地方工作，只逼吃了一口蛋糕，头孢没吃
18:50我去了下律所，回家后打了2电话不接，过一会说吃药回来，不说话
21:25 9点出门，至少25才上楼，楼下至少呆了10分钟，大概率是抑郁了，9.40我忍不住给他吃药`,hh:[],s3:0,s4:0},"2026-05-01":{detail:`上午我睡觉，一直听到打嗝
13:08盛饭给他吃不吃，问昨天一天有没有吃过饭，回答忘记了，我问有没有大发，我生气说这饭放到晚上不吃我就再也不管了，看了他外卖软件，昨天没点过外卖，我很凶的逼吃了，吃了大半后，我说吃得不痛苦要吃，他说痛苦的。
14:50梦境
14:56确认了昨天今天发得都不多，叫不出门
18:52一直打嗝
19:54回来以后房间里坐着不动很久，问情况，说昨天开始就讨厌爷爷声音，今天说对小孩太响了之类的，以前我说的时候，他是说不要紧白噪音的
20:00在看和娘娘的聊天记录，忘记了太太还压岁钱的事是25年10月21的事，说了以后想的起来`,hh:[14],s3:0,s4:0},"2026-05-02":{detail:`问这两天麻吗，说忘记，反复问还是说忘记
12:20骑车去美兰湖买玩具，心情也没改善，买玩具的时候有点不开心，说我买太贵之类的，就更不开心了，然后到罗南休息会，话也不说了
20:01今天不舒服也差不多，没重的，大概没的
20:31我觉得是有不舒服的，自己说说不清，过一会自己也觉得有了，表现是打嗝，咽了一下口水，32，用被子遮头，问话和拉被子，他摇手，拒绝我，好像怕光，34头，出被子了，还没好，打嗝，问有梦境吗，手表示有，怕光吗，不，现在好了吗，是，现在是35，我估计是出被你好的，这次很严重吗，是的，超过10分，15不到，13分，是不是最近以来最重的，手指回答不一定，一直不愿意说话，还打嗝，现在是46，然后问有没有断片，表示不确定，问知不知道什么季节，早上晚上，知道的，问记忆正不正常，表示不正常，知道小哈生过病，想起来吃过生煎，奶茶，21.22，能回忆今天行动的一些碎片，不能完全连起来，基本能连`,hh:[20],s3:1,s4:1},"2026-05-03":{detail:`7.35遮眼，7.37做起来自己醒的
08:27告诉我鬼压床好几次，分布在整个睡觉，起床到现在没有
10:35到现在没有
14:52不舒服，在吃饭，还说面条有铁锈味，5分以上，10分以下，问是不是第一次，说不是，最后确认5次左右
15:07不舒服，在看自己朋友圈，10分，30秒，有点橡胶
17.18 梦境10分，橡胶，30秒
18.48 梦境从8分到11分，橡胶，我问的30秒
确认自己也觉得每次超重，但时间没变长
22:22没有不舒服`,hh:[14,15,17,18],s3:0,s4:5},"2026-05-04":{detail:`没麻
10:28没重的
12:47没有，在美兰湖小菜园吃完饭
15:46不舒服，8分重，20秒有味道
16.37 梦境8，30秒
...
18.57 梦境8，橡胶
19.14 梦境8
23:01不舒服，刚在玩体力游戏，太痴了，10分，20秒`,hh:[15,16,17,18,19,23],s3:0,s4:1},"2026-05-05":{detail:`早上刚说没麻，我睡醒10.25问说不知道，问有没有重的也不知道，早上一直在打嗝，硬问说没重没麻
14:23在美兰湖玩，和小哈不开心，问了，说不知道，然后立马不舒服了，6分，30秒，橡胶
17.36 梦境7
18.06 梦境8
18.43 梦境7
20.34 梦境7`,hh:[14,17,18,20],s3:1,s4:1},"2026-05-06":{detail:`应该有，问了半天说不清，最后说了昨天有，今天也说不清
10:10带耳机睡觉, 不是立马睡着, 应该11睡的, 13.30醒，晚上10点聊到是有心情不好，讨厌爷爷和我视频的声音
16:51没有重的，睡觉没麻
18.44 梦境，20分，很重，30秒，我在房间，但是不在一起，补充，看了录像，在找我一起看电影，中间有5秒不动，所以看起来虽然重，但是时间不长，现在时候追问确定是超过10分很重的
20.51 梦境8`,hh:[18,20],s3:0,s4:0},"2026-05-07":{detail:`没麻，我没睡觉，肩膀疼，2点多出房间的
13:51忘记，但是应该没重，我们看电视到1030我睡着，我1不到醒
15:31忘记，但是没重的
18:02打嗝，问有没有不舒服，说不知道，事后也不知道，我认为是不重，没有梦境的
20:44不舒服，和小哈吵架，小哈反悔穿衣服之类的，8分，40秒，我刚睡醒不久，问之前有没有不知道`,hh:[20],s3:0,s4:1},"2026-05-08":{coner:["华山/朱/吡仑帕奈减1","晚上吡仑帕奈减到3粒"],detail:`没麻
09:55没有重，轻的忘记，吡仑帕奈减到3，左乙拉西坦换布利西坦，奥卡西平换国产。奥卡西平是都没了，但左乙拉西坦总院有的，具体原因问不清楚，但布利西坦是升级版，就没多问，也可能是本人说记性不好的原因
11:57左脚踩棉花，02还没好，到现在没发作，44到蟠龙天地问好了
16:18到家了，今天大概都没不舒服
18:42可能有过，5分
19:27熟悉，8，9分，30秒多，估时间一直很准
写微博的日子：430，318，311，223，115，113，930了，然后现在说到731的，说前两天也看到任何人都讨厌
22:21大概没有`,hh:[18,19],s3:1,s4:1},"2026-05-09":{memo:"总结",detail:`7.22 我听到声音，非常明显的发作迹象，一个轮回是呼吸加咂嘴，然后放松式的吐气，25分醒过来问，说是"鬼压床"，眼睛跳，看录像，21分坐起来，过一会停着了，22躺下去，我是22末起来看的，他23.30动，可能是好了，25起来了
10:07 没重, 因为罚款300的事打嗝很多
11:27 因为在总结, 特地确定, 这一小时多, 没有任何发作
11:47 有的话也是很轻的被压下去的
复盘从25/10以来发作变化:
对比之前: 
25/9头 这个阶段是10分钟左右一次, 每天有100次左右, 程度是2~4分, 时间5秒~10秒. 现在"想吐和想拉屎"没有, 现在发作的情况就是梦境熟悉, 橡胶偶尔有, 橡胶和重的有关联, 但不一定. 大概3, 4次有一次橡胶.
看到泪流满面的记录, 答近一周有一次, 具体不愿意说, 再问一个月的, 就不记得了.
25/10末 开始发作次数减少, 总的减少一般, 其实是减少了频率, 会有一些时段不发.
25/11/4 第一次有7, 8分程度的, 但是大多数还是5分以下, 10秒一下的. 11/8第一次有橡胶
25/11/29 开始有比较重的梦境了, 30号有9分. 这个阶段的发作增加了"普通发作", 5分~8分, 30秒~1分钟的. 另外轻的发作也是有的, 记得12/13在阿妈手作问的, 频繁的时候还是有15分钟一次. 这个现在应该频率少很多了, 甚至不太有.
12:50打嗝多，有压下去的，没发出来的，在宝杨路违法处理这里，因为有个违章加罚没通知
13:25不舒服，40秒，6，7分，今天第一次，去海上世界路上
15:46回家路上拉屎，梦境，6分，20秒
17:14不舒服，6分20秒
18:30有过一次差不多的
19:41梦境，熟悉，打嗝很多，50秒，7分
22:42洗澡回来，没有
23:33打嗝多，准备睡觉，然后说，今天一整天有1，2次被压下去的`,hh:[7,13,15,17,18,19],s3:0,s4:4},"2026-05-10":{detail:`问麻没麻说不知道，大概没有
08:26不舒服，打嗝2次，1分半，3分重
11:24没有，轻的也没有
13:31没有不舒服
14:28压住了
14:51压下去，去远香湖路上
16:32不舒服，拉屎，1分钟，超过10分，11，12，有橡胶
20:48吃好捞王回来，压下去了
22:33有过压下去`,hh:[8,16],s3:0,s4:5},"2026-05-11":{detail:`没麻，但是没睡好，醒的很早
09:43 到罗南, 早上拉屎拉不出, 要去罗南, 然后屋里玛丽, 我睡觉比较少, 没耐心了, 态度比较差
13:14 都睡了会醒了, 问有没有不舒服, 摇头, 再问, 捂住我嘴, 我问是不是不要说话, 点头, 之后去厕所, 一直没回来, 估计又抑郁了, 所以讨厌我, 14.23 我找他, 客厅里看到他, 他看到我就把手机放起来, 可能刚才在手机里写我不能看的东西.
17:31早上到现在没重，都是压住的
18:17一直打嗝，说压下去
19:53应该没有
21:45应该没有，也就是今天没有重的`,hh:[],s3:0,s4:2},"2026-05-12":{detail:`没麻，睡得不好
08:16梦境橡胶，因为遇到了黄栌累，4，5分
08:21二次碰到又有一点
09:28熟悉了，橡胶，5，6分，20秒
11:40和奶奶银行回来，应该没有
1155 4，10
13:49我睡了一会，他叫醒我关空调，然后卷到一边，我去看他，拒绝，问有没有不舒服，摇头，我觉得有点异常所以记录，可能是怕电风扇？昨天下午好像是和外婆不开心，56起来擦鼻涕，我趁机问是不是冷了要不要关电风扇，嘴巴回不用，然后躺下去还是躲到角落，我还是关了，我看他一下，他很拒绝的样子，像刚吵过架一样推开躲角落，被子捂起来，后来感觉还好
14:43打嗝还是有，从早上到现在大概没有重的
18:55大家跟小哈吵架，没重的，说不看到他就没不舒服
19:31梦境，熟悉，30秒，在和小哈玩，10分以上，13，14分。
20:34不舒服，刚洗澡出来，20秒，8分`,hh:[8,9,19,20],s3:0,s4:1},"2026-05-13":{detail:`没麻，但是经常醒，我理解就是不厉害的发作，他又说以前正常也会这样
13:00天街吃饭路上，6分20秒，中午睡觉没麻
18:15到现在有过2次，就是这段时间的，5左右，肚子开始不舒服，心理紧张`,hh:[13,18],s3:0,s4:3},"2026-05-14":{detail:`没麻，睡得一般，但是手表非常差，打断多
10:28没有不舒服
16:30有过1，2次中等的，是5分，打嗝多
20.00 梦境6
20:48没有不舒服，但是肚子疼，2分，早上也是
晚上1点左右给带上手表的`,hh:[16,20],s3:0,s4:1},"2026-05-15":{detail:`没麻，睡得差，从手表看，比昨天好很多，打断是多，但是零碎不持续很久
09:47打嗝稍微多，没不舒服
11:284，5分肚子疼了，问梦境，拒绝回答
18:02有过1或2次中等的，5分
19:46没有重的
20:49没有重的，在赶活，不太理
23:47 没有`,hh:[11,18],s3:0,s4:3},"2026-05-16":{detail:`没麻，睡觉显示3点前一直醒着，4点后睡得可以，722醒的，可能是肚子疼
11:50起床到现在没重的，现在肚子1分疼了，中等也没有，轻的像以前那样频繁的也没有
17:39没有重的，中的可能没
20.55有次熟悉，中的，顾村吃了牛肉火锅，我肚子疼
23.10 梦境6分，熟悉，变8分（自己记录的）
23.32 梦境
01:24准备睡觉`,hh:[20,23],s3:0,s4:0},"2026-05-17":{detail:`没麻，1.53睡到3点，完全醒到4.45，后面断断续续到8.10，可能还是肚子疼
11:34没重的，还是肚子疼，所以没心情
15:17问多吗，摇头，问记了吗，摇头
17.41 梦境3分
19:41一边工作，一边小哈找玩，有点想吐，有点打嗝
20.45 梦境8分，40秒，今天没吃饭，吃一个鲜花饼
21.32 梦境7分
23.07 梦境8分
23:41打嗝很多`,hh:[17,20,21,23],s3:0,s4:1},"2026-05-18":{detail:`没麻，睡觉竟然非常好，说明之前是肚子疼或者小哈
11:30肚子1分，起床到现在没重的，中等的不一定有，打嗝多，我刚睡醒
15:59没有，打嗝有
18.08 梦境8
18.54 梦境6
20:54有6，7分，半分钟，因为在纠结小哈咳嗽我凶了他
22.05 梦境9
01:19来回翻身和青蛙叫，右脚在我腿上，偶尔会抽一下`,hh:[18,20,22],s3:0,s4:1},"2026-05-19":{detail:`没麻，睡觉还可以，打断多
14.32 梦境7分30秒，下午睡觉睡到2点多，11点开始睡的
18:54梦境，7分，十几秒，说溃疡只好过几天
20:20不舒服，10分，慢慢起来的，之前也有过慢慢来的，一开始说不知道是不是的，有味道的，20秒，然后一直打嗝
20:58不舒服，12分，橡胶，半分钟，20秒，一下子没有的
22:35洗好澡了，大概没有`,hh:[14,18,20],s3:0,s4:2},"2026-05-20":{detail:`没麻，睡觉手表可以
09:14想吐，梦境，熟悉，有味道，12分，半分钟，我觉得大于半分钟，在吃早饭回来路上
12:26肚子有1，2分，但是酸，重的梦境没
13:26梦境6，7分，10秒
15:16吃饭兜了圈回家路上，7分，30秒
16.54 梦境12，30秒
18.03 梦境10，橡胶，一直在看视频，吴青峰，打嗝多
18:55梦境8分14秒
19.17 梦境6
21:17梦境6，7，嘴巴里都是大蒜味道，吃的时候不讨厌，发作时候讨厌，20秒
22:07不舒服，11，12分，30秒`,hh:[9,13,15,16,18,21,22],s3:0,s4:2},"2026-05-21":{memo:"吃药晚了4小时",detail:`早上好像麻，晚上043到134醒着，录像看是小孩动了下，早上7.09醒的遮了35秒眼睛
！！！早上没吃药，下午1点吃的
08:04梦境，5，6分，15秒
10:16没重的，一直打嗝, 说肚子还疼, 1分
12:34不舒服，梦境，40秒，11分，有味道的
12:59现在才想起来吃药
15:36在买保险要等，没有不舒服
18.00 熟悉5分
19.37 梦境6
20.06 梦境13
21:00梦境13分，1分钟，吃东西停下来的，发的时候掐我的（不是特别重，但是觉得在掐，发完打了个很大的隔）
23:01两个人已经睡着，但估计后面还要起来穿袜子，06分动了下，曲着身体睡了，45又醒过来，给小孩子穿袜子，躺到门口去睡了，不知道打算出去还是什么
02:11醒过来了，又继续睡
03:29我在外面，两个人开门出来，小哈口渴`,hh:[7,8,12,18,19,20,21],s3:1,s4:2},"2026-05-22":{detail:`没麻
0751 梦境10
14:25睡了会，睡着的，没不舒服，还是肚子疼
15:51不舒服，15秒，4分，有味道
18.25 梦境12
19.43 梦境12
20:56洗澡回来，说忘记有没有重的了
00.04 梦境10（自己记录的，而0.36却说没）
00:36吃好烧烤回来，没有（现在是我洗澡洗好）
01:32一直说话到现在，准备睡`,hh:[7,15,18,19,20],s3:0,s4:1},"2026-05-23":{detail:`没麻
12:58睡了会起来，没有
15:08说忘记，看手机也没记录过，说肚子疼，2边都疼了
19:39我睡醒不久，没重的，但是后来问，又说不知道
21:04又聊到小孩没妈妈之类的，但确实一直有说
21:11左边屁股和手麻，3分钟好的
22:25洗澡出来问有没有重的，之类的，全部拒绝回答
23:29还是拒绝回答`,hh:[21],s3:0,s4:0},"2026-05-24":{detail:`0950问晚上麻没麻，说不知道，起床到现在有没有不舒服，也不知道，有没有重的，我不知道，早饭也不吃，大概是肚子疼，没心情
14:30没有重的
16.23 轻的3分
17.01 轻的2分
17:24没重的，我睡醒了
21:01大概没重的
21:45没有，今天明显打嗝变少
23:30又不愿意说话，最后说是肚子疼`,hh:[16,17],s3:1,s4:2},"2026-05-25":{detail:`没麻
08:48打嗝又多了
10:57打嗝变少了，准备去和小婷玩，没有不舒服，肚子还是疼
16:48没重的，中等的忘记了`,hh:[],s3:0,s4:0},"2026-05-26":{memo:"开始睡觉麻比较多, 几乎每天都说不知道麻没麻",detail:`没麻，睡觉很少，晚上停水等水来洗澡，12点睡，到2点才睡着，6.41醒了，视频看12以后是睡的
11:02没有不舒服
12:34 打嗝多, 但明确没有梦境, 麻, 叮叮
15:35大发了，嘴巴发声音，我去看的，咂嘴，手脚没抽，在睡午觉，估计1分15秒，42，写完后去问情况，拒绝回答，捏手也拒绝，45，硬问，行为告诉我没问题，但是没说话，可能累，1605说是鬼压床，全程有意识
16:04说有过梦境，从发作完到现在之间，10分重
17:15没有
18:34没
18:54没有
20:44没
21:21洗好澡，2次重的，10以下
22:28有过，6分左右`,hh:[15,16,21,22],s2:1,s3:0,s4:0},"2026-05-27":{detail:`说不知道，但是睡觉非常好
08:21没重的，轻的不知道
10:12没有，想不起来朱名字，16想起来了
13:03没有
15:17不舒服，梦境，熟悉，10秒，不重
18:42没有，看完太太在馄饨店
20:21没有
22:05 洗完澡, 说洗澡前帮小哈弄衣服的时候有一次20分的, 特别重的, 具体说忘记了, 没断片, 又说大概是12, 3分, 反正确定是重, 问是不是比前两天都重, 说不知道了, 是因为奶奶在房间里说话, 他发了不好意思说
23:01 不舒服, 30秒, 8分左右`,hh:[15,23],s3:1,s4:1},"2026-05-28":{detail:`回答不知道，睡觉不错，但我感觉有一次好像靠着我轻度的抽，待看录像，看了没看出明显的，睡觉是好的
08:52 没有昨天晚上写的
10:15手和腿都涨烫，收到大手臂中间，脚是脚掌，都是左边，下了地铁去一妇婴路上，下地铁有的，到医院好了，重的梦境没，轻的忘记了
10:54看病结论：打针，抽血，一个月后再来打针，验血血常规肝肾功能ca125199，都没问题
12:13吃好饭，没有
13:45走到大悦城路上，左边身体有点晕，不重
14:03熟悉感，6分，20秒
15:57没有
18:03不舒服，梦境，熟悉，没味道，7，8分重，30秒，只是在说强迫症，又说外婆的事，自己打算挂号
20:04我睡了会，问，应该没，他在干活
20.17 自己记录12分
21.28 自己记录6分
21:58洗好澡，说忘记，第二天早上补充：前面2条看手机补的`,hh:[14,18,20,21],s3:1,s4:0},"2026-05-29":{detail:`睡觉不错，又说忘记，看他手机昨晚21.58说忘记，是有重的的
07:36 刷牙的时候有10分的，今天和小哈一起参加幼儿园活动，36出门的，上次活动25年底我去的
11:52从幼儿园回来了，没有重的
14.45 梦境5，自己记录
15:37睡了会，没有麻，有没有重的不知道，可能有一次，但不一定
16.18 梦境6
16.28 梦境4
17.54 橡胶
18.02 梦境4
20.43 梦境3
21:43出门吃烧烤
00:17没有重的，但是最后半小时都快睡着了，轻的不知道`,hh:[7,14,16,17,18,20],s3:1,s4:0},"2026-05-30":{detail:`睡觉不错，又说不知道，9.24问起来到现在怎么样，还是不知道，有没有重的，不知道，他过来拉着我，我状态不好，4点睡的，说话态度不好，他又回去躺着了
13:29问了，还是不知道
19:30昨天去幼儿园看演出热泪盈眶，问下午有没有重的，也说不知道
22:37还是都不知道，但总体来说我觉得是还可以的`,hh:[],s3:1,s4:0},"2026-05-31":{detail:`问的时候说, 觉得前两天有过一次鬼压床,也可能是今天, 不知道了
09:15 起床到现在没有过
11:00因为小哈生气，拿奶茶自己走了，路上分开了，后来在超市坐着，突然又走了，没跟我说，奶茶也不拿，上电梯还推开人走路，后来碰到了恢复了
12:36不舒服，刚到家，因为一直打嗝才问的，这几天好像没一直打嗝了，4分重，20秒
15:41不舒服，打嗝，10分重，30秒，确定是今天第一次重的
17.31 梦境熟悉
19:20不舒服，在海上世界，味道比较重，重的时候才有的味道，10分才有的，但是梦境没有
23:09洗好澡，2次重的，一次回家路上，一次刚才，10分的，30秒
23:46想吐，15秒，猜是5分
00:01 叫了一下，16秒转过去继续睡，我在看电脑`,hh:[12,15,17,19,23],s3:1,s4:2},"2026-06-01":{detail:`又忘记了，每天都是能幻想那个麻，但又不确定是不是真的
09:56没重的，这两天又在说外婆
1130睡觉，13.41微信给我发了个1，我先看录像，再进去，没事，没麻
15.15 梦境
15:38没有重的，我睡觉醒，有5分以下轻的，我睡觉的时候听到一直打嗝
22:43没重的`,hh:[15],s3:1,s4:1},"2026-06-02":{detail:`忘记，半夜醒过，入睡没麻，问早上有没有麻，就不知道了，但是感觉偏向于没有，又补充说“醒来都不知道在哪里”，指不知道在爷爷奶奶家，还有不知道是早上还是晚上，但是很快就反应过来了，说觉得正常人也这样，这几天里有过几天是这样的
08:51不舒服，刚陪我吃好早饭，10秒好了又有了，只有熟悉，30秒加起来，10分，发完说“完全无法描述刚才的场景”，说一天奶奶坐我后面也有过应该是前天回家路上
10:56又以为早上
13.03 梦境
15:15梦境熟悉，刚买好保险，过会接小孩去梧桐，手涨，20秒，8分
15:32手涨
19:18吃好到家，有过2次重的，8到10分，有的是光想吐，有的光梦境
21:05 梦境，20分，1分钟
21:22不舒服，没上次重，40秒，6分
23:22不舒服，物理加化学，打嗝多，40秒，5以上`,hh:[8,13,15,19,21,23],s3:1,s4:2},"2026-06-03":{detail:`没麻，今天说没有了
07:37不舒服，程度高，1分钟，8分
9.01 自己记的重，差不多10分
14:37不舒服，刚睡醒，40秒，20分，梦境，睡觉不麻
16:04不舒服了，熟悉感开始的，在幼儿园门口，问是不是问过，50秒，我看时间是30秒，12分
16:34压下去
16:35不舒服了，15秒，2，3分
18.01 自己记录重12分60秒
20.00 自己记录重
20.44 自己记录重，说这两次有一次20分的`,hh:[7,14,16,18,20],s3:0,s4:1},"2026-06-04":{detail:`不一定有麻
08:05有过20分的梦境，但是不是很确定
09:30一点点不舒服，2，3分的
13:58睡醒，没麻
15:55我在刷视频，他拿耳机戴
15.47 自己记录6分变10分
...
17.51 回忆路上可能有过1次
21.39 回家路上梦境10
22:24洗澡没有`,hh:[10,16,17,21,22],s3:1,s4:2},"2026-08-26":{detail:`没麻，起床有感觉压下去了，而且感觉每天都是，只是今天压下去了，但是前几天明明记录没麻，就不能确定了
吃早饭我发脾气左手臂麻烫风凉
12:02小发，咽口水出声我发现的，发完问是鬼压床
19:13梦境10分
20:16梦境3，4文峰剪好头
00:44叫了一声，看监控还好，可能是翻身`,hh:[0,12,19,20],s3:1,s4:2},"2026-08-27":{detail:`没有
9.19 自己6
13.28 自己5
15:40梦境5，打嗝问的
17.09 自己5
17.13 自己5
21:45没20`,hh:[9,13,15,17,21],s3:0,s4:5},"2026-08-28":{detail:`没有
16:35不舒服，然后打嗝，9分，化学的
17.04 自己9
18:25不舒服，物理，有一瞬间觉得奶茶难闻，8分
20:20不舒服，买好百果园和优衣库，化学，10分，半分钟
20:26又有了，很难过，看起来很重，我熄火，他让我别说，嘴里一直"嗯嗯啊啊"表示很难受到30末，开始有点抽，20秒左右，在摩托车后座我扶着，抽的范围是头颈及以上，歪头歪眼的。5秒后流口水，叫了不应，应该是没有意识，1分钟恢复，下车，37分出发回家，到家门口，记忆没问题，表达能力有问题，说不出刚才买的水果的中文名字，只能说grape banana西"妹"，去年有一次说小哈是"小花"
20:54感觉刚才去天街是3天前的事，但知道是刚刚去的，说单从味道还在嘴里，可能是这样，自己又觉得这两天强迫症厉害
21:14有过8分，短的，20左右，然后回忆今天经历的事，说隐隐约约都是梦的感觉
21:25又来了一阵子，又打嗝，说还有单丛的味道
21:27又有了，"梦境里经常出现的画面"，提到是不是叶子很厉害，说明还记得奶茶的样子
21:42去洗澡，51回来，应该有过，但是不确定
23:14有过5`,hh:[16,17,18,20,21,23],s2:1,s3:0,s4:9},"2026-08-29":{detail:`没麻
说有过
09:51左脚麻，到小腿一半，持续到1.16还有一点
12.05 自己6
17:04不舒服，物理的厉害，觉得一模一样，刚打扫好房间，1分钟，9分
18:54梦境10
23:43物理`,hh:[9,12,13,17,18,23],s3:0,s4:5},"2026-08-30":{detail:`没麻
16:36没有重的，5到10的一小时4次
17:09浓度高，短，6分，最近几次都这样
18:00梦境5到10
23:27没有20`,hh:[16,17,18,23],s3:0,s4:6},"2026-08-31":{detail:`没有
18:34熟悉，8分，今天没20，没10，频率还是高，一小时4次
20:42梦境10
20:53不舒服，物理，10分
21:18左边烫
21:54梦境5`,hh:[18,20,21],s3:0,s4:7},"2026-09-01":{detail:`不知道有没有麻
08:05梦境，化学，10
16:41梦境8分，我和小哈硬买了他不肯买的东西
19:33梦境10
20:20洗好澡，忘记了
20:30梦境，说肯定有10，但是是"化学"，所以不那么难过，持续30秒
21:23梦境6，因为小哈摸了她的手不洗手`,hh:[8,16,19,20,21],s3:0,s4:5},"2026-09-02":{detail:`没有
10:50到青浦了，路上没有，后来五月广场兜了圈，再彩虹桥走了一半，然后去万达，大概1230多到的
12:59鸡皮疙瘩，下雨了，早上就说喉咙烫
13:33梦境，30分，最重的一次，可能在发烧，截图，说"太难受了"，截图，好一点了，烫
13:47两边太阳穴都疼
14:22 在卫生院量了38.6，医生说不太准
14:24布洛芬，6小时间隔，头涨
15:22梦境，在路上，人有点往后靠了
15:25 我停车问，不太能说话，问能不能说话，让说我们去干嘛，说了一下"回家"
16:07到家，觉得路上睡着，迷迷糊糊，量不出体温高，摸了也不明显，之后也是
16:26去接了小哈，回来说不记得，肯定发了，待看监控
18:02 梦境10，之前打嗝多，但说不是，发完后太阳穴和眼睛疼，之前好点了，打嗝频率很高到16分还在打，后来开始玩手机，41还在打
19:57洗澡的时候，化学，9分
20:12胀气，大的那种
20:59太阳穴疼，很疼，肚子涨得放了4个屁，1个嗝
23:17梦境，20秒说一模一样，说20，截图是40秒，然后好了，我决定吃布洛芬
23:32太阳穴疼`,hh:[10,12,13,14,15,16,18,19,20,23],s3:2,s4:4},"2026-09-03":{detail:`没有麻，起来不热了，问昨天去什么医院，觉得星期一，要求我直接说，放弃想，我说了昨天的经历后，只能记得一点碎片
14:13应该没20分的，但是记性感觉不那么好，可能是昨天发作导致的
17.57 补自己10
19:08没有20，有10，2次，5的一天5次以内
19.21 自己6
20.18 自己20（10加10）
20:49梦境
21:01说刚才的梦境10导致的呕吐难受
21:08梦境，5到10`,hh:[14,17,19,20,21],s3:0,s4:14},"2026-09-04":{detail:`没麻
12.21 补自己➕20
16:01有一次20，没有10，5的5次左右
16:44梦境9
17:57不舒服，话都不说，有意识，肚子叫，1分钟，10分
18:10看到ai软件上问的问题，问是不是我问的，然后翻微博，也都不记得
18:18又梦境了，40秒，10分
19:07忘记圈圈去年送花
22:28梦境，熟悉，40秒，说"这几次都这样，比最重的轻一点"，8分`,hh:[12,16,17,18,19,22],s3:2,s4:9},"2026-09-05":{detail:`没麻
11:10说早上还觉得小哈在放假，没10，低的有的，大概40分钟前心跳快
18.34 自己4
18.59 自己5`,hh:[11,18],s3:0,s4:2},"2026-09-06":{detail:`没麻
12:55梦境3，4，到现在没10
13:05麻到小手臂
19:01不舒服，重，50秒，10分，一天没吃饭，晚饭吃很多，吃完又在看搞笑视频
22:21没有10，但是上次记录了10，应该是忘记了`,hh:[12,13,19,22],s3:0,s4:2},"2026-09-07":{detail:`没麻
15:01我睡觉起来，他一直打嗝，因为觉得我睡觉了晚上就不睡了
15:47今天没10，打嗝严重`,hh:[15],s3:0,s4:0},"2026-09-08":{detail:`没麻
13:18不舒服，然后打嗝，7，8分，在图书馆
13:48在最美丽吃饭，觉得都梦到过，没有其他不舒服
23:45动，问怎么了不回，确认是麻了，睡下去的时候打过嗝，问过没20`,hh:[13,23],s3:0,s4:3},"2026-09-09":{detail:`早上没，就昨晚的
今天也去图书馆
15:36吃饭聊天，说说过一样的，说刚才吃饭也觉得吃过一样的，然后说放弃了
17:54不舒服，打嗝，5到10
23:47今天和昨天的记忆还可以，没有20，10可能有`,hh:[15,17,23],s3:0,s4:3},"2026-09-10":{detail:`起来的时候麻，0点睡的，没拉窗帘，6点醒，具体忘了
17:26梦境10，说昨天还是今天有20，是我睡觉的时候
17:58刷牙的时候10
19:05不舒服了，5
19:15不舒服了，5分，平时最多的就是这样，梦境的感觉，但知道不是梦境
19:32梦境，10以上，1分钟不到，算20
20:35不舒服了，20秒，5
23:44熟悉，梦境，5`,hh:[0,6,17,19,20,23],s3:1,s4:6},"2026-09-11":{detail:`不知道有没有麻
09:21因为送小孩的事跟我争了几句，回家睡觉了，我觉得可能有不舒服，因为晚上睡觉时间是够的
14:25一直打嗝，不吃东西，我吃肉包说难闻，然后睡到快4点
16:16梦境10
20:31不舒服，10，今天没20
21:02吃了口韭菜，10
23:35梦境4`,hh:[9,14,16,20,21,23],s3:0,s4:4},"2026-09-12":{detail:`不知道有没有麻
11:16拉屎回来又死样怪气问有没有不舒服说没又蒙着脸睡觉
13:47梦境6
16:46不舒服，之前也有2次4分，都是打嗝发现的，这次6`,hh:[11,13,16],s3:0,s4:4},"2026-09-13":{detail:`不知道
14:17在美兰湖小哈发脾气，5分
17:32梦境，4，刚吃好饭
19:16没有20，有10，1次
19:45不舒服，10分
21:32洗完澡，不舒服，4，洗澡的时候应该有，10`,hh:[14,17,19,21],s3:0,s4:6},"2026-09-14":{detail:`没麻
13:47梦境4
15:15心悸，梦境1，2分
20:58梦境10
00:04动了下，转身，有打嗝，所以记录`,hh:[0,13,15,20],s3:0,s4:3},"2026-09-15":{detail:`晚上麻的
15:55梦境10分，打嗝持续很久，说从1.30睡醒起来就有，一共2次
20:56今天没20
23:03梦境5到10`,hh:[1,15,20,23],s3:0,s4:3},"2026-09-16":{detail:`没麻
09:39打嗝多，心悸，脑子紧
19:39梦境，说吃的香肠难吃，20分，好的比较快，感觉快有鸡皮疙瘩，有点失重`,hh:[9,19],s3:1,s4:0},"2026-09-17":{detail:`没麻
07:51梦境10分
14:09打嗝3分
15:45梦境10
17:56梦境10
...
19:15 梦境10
20:26梦境4
今天自学comfyui 打嗝多，这两天还有尿尿多`,hh:[7,14,15,17,18,19,20],s3:0,s4:8},"2026-09-18":{detail:`没麻，今天去医院，还是普通配药
11:34不舒服了，在蟠龙天地，10
13:15不舒服，5，在吃陈香贵，南翔
14:06不舒服，10
下午和小婷大悦城玩
