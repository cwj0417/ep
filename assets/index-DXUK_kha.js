...
00:47打嗝一下，不知道有没有恍惚
0807起床啥都不知道，眼神呆滞
半夜麻了0次，睡醒麻了0次`,hh:7,s3:0,s4:2}},ar={id:"cont-wrap"},ur={id:"calender-wrap"},dr={id:"calender-head"},hr={class:"calender-year"},pr=["onClick"],gr={class:"date"},mr={class:"strat"},_r={class:"opt-head"},br=["onClick"],yr=["onClick"],vr={class:"strat setall"},xr={key:0,class:"tag s3"},wr={key:1,class:"tag s4"},Sr={key:2,class:"tag hh"},Cr={key:3,style:{"font-weight":"900","font-size":"16px",padding:"10px 20px"}},Tr={key:4,style:{"font-weight":"900","font-size":"16px",padding:"10px 20px"}},Or={__name:"App",setup(e){const n=M=>M<10?`0${M}`:M,t=M=>{const A=new Date(+M);return`${A.getFullYear()}-${n(A.getMonth()+1)}-${n(A.getDate())}`},s=Object.fromEntries(Object.entries(fr).map(([M,A])=>[new Date(M).valueOf(),A])),i=["2024-01-27",t(Date.now()+864e5*7)],l=(new Date(i[1])-new Date(i[0]))/864e5,r=new Date(i[0]).valueOf(),o=rs(new Date(i[0]).valueOf()+864e5*4),f=tt(Ms);let h={};const u=M=>{var A;(A=h[M])==null||A.scrollIntoView({behavior:"smooth",block:"end",inline:"nearest"})};let p=0,S=null;const T=rs(!0),H=M=>{if(!S){const A=M.target;T.value=p>A.scrollTop,p=A.scrollTop;const C=new Date(i[0]).valueOf()+(new Date(i[1])-new Date(i[0]))/A.scrollHeight*(A.scrollTop+A.clientHeight/2);o.value=C,S=setTimeout(()=>{S=null},350)}};let I=null;const Y=M=>{I||(T.value=!1,I=setTimeout(()=>{I=null},350))},j=M=>{for(const A in Ms)f[A]=M?0:-1};return qt(()=>{const M=document.querySelector("#calander-body");M.scroll(0,M.scrollHeight*(new Date-new Date(i[0]))/(new Date(i[1])-new Date(i[0]))-M.clientHeight)}),(M,A)=>(se(),re(oe,null,[z("div",ar,[z("div",ur,[z("div",dr,[z("div",hr,de(new Date(o.value).getFullYear())+"年"+de(new Date(o.value).getMonth()+1)+"月 ",1),A[2]||(A[2]=S0('<div class="calender-item">周日</div><div class="calender-item">周一</div><div class="calender-item">周二</div><div class="calender-item">周三</div><div class="calender-item">周四</div><div class="calender-item">周五</div><div class="calender-item">周六</div>',7))]),z("div",{id:"calander-body",onScroll:H},[(se(),re(oe,null,Nn(l,C=>z("div",{class:sn(["calender-item card",{active:ye(r)+C*864e5-o.value<864e5*31&&new Date(ye(r)+C*864e5).getMonth()===new Date(o.value).getMonth()}]),onClick:F=>u(ye(r)+C*864e5)},[z("div",gr,de(new Date(ye(r)+C*864e5).getDate()),1),xe(cr,{strategy:f,record:ye(s)[ye(r)+C*864e5]},null,8,["strategy","record"])],10,pr)),64))],32),z("div",{id:"strategy-select",style:et(`transform: translateY(${T.value?0:"100%"})`)},[(se(!0),re(oe,null,Nn(Object.entries(ye(Mt)),C=>(se(),re("div",mr,[z("div",_r,de(ye(rr)[C[0]]),1),(se(!0),re(oe,null,Nn(C[1],(F,ce)=>(se(),re("div",{class:sn(["option",{active:ce===f[C[0]]}]),onClick:_e=>f[C[0]]=ce},de(F.name),11,br))),256)),z("div",{class:sn(["option",{active:f[C[0]]===-1}]),onClick:F=>f[C[0]]=-1}," 不渲染 ",10,yr)]))),256)),z("div",vr,[z("div",{class:"action",onClick:A[0]||(A[0]=C=>j(!0))},"恢复默认"),z("div",{class:"action",onClick:A[1]||(A[1]=C=>j(!1))},"关闭渲染")])],4)])]),z("div",{id:"detail",onScroll:Y},[(se(!0),re(oe,null,Nn(Object.entries(ye(s)),([C,F])=>(se(),re("div",{class:"detail-card",ref_for:!0,ref:ce=>ye(h)[C]=ce},[Di(de(t(C))+" ",1),F.s3?(se(),re("span",xr,"小发 "+de(F.s3),1)):gn("",!0),F.s4?(se(),re("span",wr,"轻微 "+de(F.s4),1)):gn("",!0),F.hh?(se(),re("span",Sr,"恍惚 "+de(F.hh),1)):gn("",!0),F.memo?(se(),re("pre",Cr,de(F.memo),1)):gn("",!0),F.coner?(se(),re("pre",Tr,de(F.coner[1]),1)):gn("",!0),z("pre",null,de(F.detail)+`

      `,1)],512))),256))],32)],64))}};sr(Or).mount("#app");
