const data = {
    // '1991-11-07': { // 这是事件的demo
    //     s1: [1, 23], // 大发作, 最靠近哪个整点
    //     s2: 1, // 吃药后出现的减弱的大发作
    //     s3: 5, // 小发作, 指比较厉害, 不能正常做事的发麻
    //     s4: 7, // 很轻微的手烫, 不影响生活
    //     hh: 1, // 恍惚发作, 最严重的发作
    //     coner: ['左', '左乙拉西坦'], // 显示在左上角, 大字, 表示经历过什么节点
    //     memo: '备注下字会比较小', // 联系什么事件, 以便回忆和查看详情
    //     detail: '详情, 会有很多' // 详情, 会有很多
    // },
    '2024-02-04': {
        s1: [7],
        detail: `
...
23：39到23：40，之前1天有半边麻。23：44 有一点意识`
    },
    '2024-03-23': {
        s1: [1],
        detail: `
...
8:07 醒了，不知道自己发过，没有不舒服
    ...
    '2024-06-07': {
        s4: 1,
        coner: ['医院', '第一次去虹桥, 开了奥卡西平, 但因为曼月乐和副作用没吃'],
        detail: `
...
22.02 左手涨烫
    ...
    '2024-09-06': {
        coner: ['医院', '第二次去虹桥, 之前取消了31的号挂了13号的, 求医生6号加了号'],
        s4: 4,
        detail: `
去虹桥看病了
15.00前2次左手烫涨
...
export default Object.fromEntries(Object.entries(data).map(([k, v]) => ([new Date(k).valueOf(), v])))
